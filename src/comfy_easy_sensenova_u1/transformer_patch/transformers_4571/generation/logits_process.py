...
class MinLengthLogitsProcessor(LogitsProcessor):
    ...
    ```python
    >>> from transformers_4571 import AutoModelForCausalLM, AutoTokenizer
...
class TemperatureLogitsWarper(LogitsProcessor):
    ...
    ```python
    >>> import torch
    >>> from transformers_4571 import AutoTokenizer, AutoModelForCausalLM, set_seed
...
class RepetitionPenaltyLogitsProcessor(LogitsProcessor):
    ...
    ```py
    >>> from transformers_4571 import AutoTokenizer, AutoModelForCausalLM, RepetitionPenaltyLogitsProcessor
...
class NoRepeatNGramLogitsProcessor(LogitsProcessor):
    ...
    ```py
    >>> from transformers_4571 import AutoTokenizer, AutoModelForCausalLM
...
class HammingDiversityLogitsProcessor(LogitsProcessor):
    ...
    Examples:
    ```python
    >>> from transformers_4571 import AutoTokenizer, AutoModelForSeq2SeqLM
    >>> import torch
...
class SuppressTokensAtBeginLogitsProcessor(LogitsProcessor):
    ...
    ```python
    >>> from transformers_4571 import AutoProcessor, WhisperForConditionalGeneration
...
class WhisperTimeStampLogitsProcessor(LogitsProcessor):
    ...
    ``` python
    >>> import torch
    >>> from transformers_4571 import AutoProcessor, WhisperForConditionalGeneration, GenerationConfig
    >>> from datasets import load_dataset
...
class ClassifierFreeGuidanceLogitsProcessor(LogitsProcessor):
    ...
    ```python
    >>> from transformers_4571 import AutoProcessor, MusicgenForConditionalGeneration
...
class WatermarkLogitsProcessor(LogitsProcessor):
    ...
    ```python
    >>> from transformers_4571 import AutoTokenizer, AutoModelForCausalLM, WatermarkingConfig
    ...
    >>> from transformers_4571 import WatermarkDetector
...
class SynthIDTextWatermarkLogitsProcessor(LogitsProcessor):
    ...
    * **Utility Functions:** Provides functions to compute g-values directly, check for context repetition, create
    ...
    Examples:
    ```python
    >>> from transformers_4571 import AutoModelForCausalLM, AutoTokenizer, SynthIDTextWatermarkingConfig
