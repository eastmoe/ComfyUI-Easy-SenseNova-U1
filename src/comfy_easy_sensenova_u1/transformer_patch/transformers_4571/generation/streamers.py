...
class TextStreamer(BaseStreamer):
    ...
    Examples:
        ...
        ```python
        >>> from transformers_4571 import AutoModelForCausalLM, AutoTokenizer, TextStreamer
...
class TextIteratorStreamer(TextStreamer):
    ...
    Examples:
        ...
        ```python
        >>> from transformers_4571 import AutoModelForCausalLM, AutoTokenizer, TextIteratorStreamer
...
class AsyncTextIteratorStreamer(TextStreamer):
    ...
    Examples:
        ...
        ```python
        >>> from transformers_4571 import AutoModelForCausalLM, AutoTokenizer, AsyncTextIteratorStreamer
        >>> from threading import Thread
        >>> import asyncio
