...
from transformers_4571.models.llava_next.modeling_llava_next import (
...
class LlavaNextVideoConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import LlavaNextVideoForConditionalGeneration, LlavaNextVideoConfig, CLIPVisionConfig, LlamaConfig
...
class LlavaNextVideoForConditionalGeneration(LlavaNextForConditionalGeneration):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> import requests
        >>> import av
        >>> from transformers_4571 import AutoProcessor, LlavaNextVideoForConditionalGeneration
