...
# Copied from transformers_4571.models.bert.modeling_bert.BertIntermediate with Bert->Tvp
...
# Copied from transformers_4571.models.bert.modeling_bert.BertPooler with Bert->Tvp
...
class TvpModel(TvpPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformers_4571 import AutoConfig, AutoTokenizer, TvpModel
...
class TvpForVideoGrounding(TvpPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformers_4571 import AutoConfig, AutoTokenizer, TvpForVideoGrounding
