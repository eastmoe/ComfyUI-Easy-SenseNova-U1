...
# Copied from transformers_4571.models.bart.modeling_tf_bart.TFBartAttention with TFBart->TFWav2Vec2
...
class TFWav2Vec2Model(TFWav2Vec2PreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from transformers_4571 import AutoProcessor, TFWav2Vec2Model
...
class TFWav2Vec2ForCTC(TFWav2Vec2PreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> import tensorflow as tf
        >>> from transformers_4571 import AutoProcessor, TFWav2Vec2ForCTC
        >>> from datasets import load_dataset
