...
class Wav2Vec2PreTrainedModel(PreTrainedModel):
    ...
    def load_adapter(self, target_lang: str, force_load=True, **kwargs):
        ...
        ```python
        >>> from transformers_4571 import Wav2Vec2ForCTC, AutoProcessor
...
class Wav2Vec2ForPreTraining(Wav2Vec2PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformers_4571 import AutoFeatureExtractor, Wav2Vec2ForPreTraining
        >>> from transformers_4571.models.wav2vec2.modeling_wav2vec2 import _compute_mask_indices, _sample_negative_indices
