...
# Copied from transformers_4571.models.bart.modeling_bart.BartScaledWordEmbedding with Bart->M2M100
...
# Copied from transformers_4571.models.bart.modeling_bart.BartAttention with Bart->M2M100
...
# Copied from transformers_4571.models.mbart.modeling_mbart.MBartEncoderLayer with MBart->M2M100, MBART->M2M100
...
# Copied from transformers_4571.models.mbart.modeling_mbart.MBartDecoderLayer with MBart->M2M100, MBART->M2M100
...
class M2M100ForConditionalGeneration(M2M100PreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, M2M100ForConditionalGeneration
