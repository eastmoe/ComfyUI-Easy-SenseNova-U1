...
class M2M100Config(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import M2M100Config, M2M100Model
...
class M2M100OnnxConfig(OnnxSeq2SeqConfigWithPast):
    ...
    # Copied from transformers_4571.models.bart.configuration_bart.BartOnnxConfig._generate_dummy_inputs_for_default_and_seq2seq_lm
