...
# Copied from transformers_4571.models.bert.modeling_tf_bert.TFBertSelfAttention with Bert->LayoutLM
...
# Copied from transformers_4571.models.bert.modeling_tf_bert.TFBertSelfOutput with Bert->LayoutLM
...
# Copied from transformers_4571.models.bert.modeling_tf_bert.TFBertAttention with Bert->LayoutLM
...
# Copied from transformers_4571.models.bert.modeling_tf_bert.TFBertIntermediate with Bert->LayoutLM
...
# Copied from transformers_4571.models.bert.modeling_tf_bert.TFBertOutput with Bert->LayoutLM
...
# Copied from transformers_4571.models.bert.modeling_tf_bert.TFBertLayer with Bert->LayoutLM
...
# Copied from transformers_4571.models.bert.modeling_tf_bert.TFBertEncoder with Bert->LayoutLM
...
# Copied from transformers_4571.models.bert.modeling_tf_bert.TFBertPooler with Bert->LayoutLM
...
# Copied from transformers_4571.models.bert.modeling_tf_bert.TFBertPredictionHeadTransform with Bert->LayoutLM
...
# Copied from transformers_4571.models.bert.modeling_tf_bert.TFBertLMPredictionHead with Bert->LayoutLM
...
# Copied from transformers_4571.models.bert.modeling_tf_bert.TFBertMLMHead with Bert->LayoutLM
...
class TFLayoutLMModel(TFLayoutLMPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, TFLayoutLMModel
        >>> import tensorflow as tf
...
class TFLayoutLMForMaskedLM(TFLayoutLMPreTrainedModel, TFMaskedLanguageModelingLoss):
    ...
    def call(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, TFLayoutLMForMaskedLM
        >>> import tensorflow as tf
...
class TFLayoutLMForSequenceClassification(TFLayoutLMPreTrainedModel, TFSequenceClassificationLoss):
    ...
    def call(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, TFLayoutLMForSequenceClassification
        >>> import tensorflow as tf
...
class TFLayoutLMForTokenClassification(TFLayoutLMPreTrainedModel, TFTokenClassificationLoss):
    ...
    def call(
        ...
        ```python
        >>> import tensorflow as tf
        >>> from transformers_4571 import AutoTokenizer, TFLayoutLMForTokenClassification
...
class TFLayoutLMForQuestionAnswering(TFLayoutLMPreTrainedModel, TFQuestionAnsweringLoss):
    ...
    def call(
        ...
        ```python
        >>> import tensorflow as tf
        >>> from transformers_4571 import AutoTokenizer, TFLayoutLMForQuestionAnswering
