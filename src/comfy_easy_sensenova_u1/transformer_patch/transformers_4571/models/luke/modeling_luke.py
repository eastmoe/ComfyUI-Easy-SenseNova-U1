...
class LukeModel(LukePreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, LukeModel
...
class LukeForEntityClassification(LukePreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, LukeForEntityClassification
...
class LukeForEntityPairClassification(LukePreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, LukeForEntityPairClassification
...
class LukeForEntitySpanClassification(LukePreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, LukeForEntitySpanClassification
