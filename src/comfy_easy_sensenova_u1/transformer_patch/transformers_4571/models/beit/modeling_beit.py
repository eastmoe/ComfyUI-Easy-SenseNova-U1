...
class BeitForMaskedImageModeling(BeitPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoImageProcessor, BeitForMaskedImageModeling
        >>> import torch
...
class BeitForSemanticSegmentation(BeitPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoImageProcessor, BeitForSemanticSegmentation
        >>> from PIL import Image
        >>> import requests
