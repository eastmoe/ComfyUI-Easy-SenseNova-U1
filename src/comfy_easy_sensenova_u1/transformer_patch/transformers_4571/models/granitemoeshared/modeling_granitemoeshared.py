...
# copied from transformers_4571.models.granite.modeling_granite.GraniteAttention with Granite->GraniteMoeShared
...
class GraniteMoeSharedForCausalLM(GraniteMoeSharedPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, GraniteMoeSharedForCausalLM
