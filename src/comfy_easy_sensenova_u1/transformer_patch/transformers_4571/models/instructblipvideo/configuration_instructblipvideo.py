...
class InstructBlipVideoVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import InstructBlipVideoVisionConfig, InstructBlipVideoVisionModel
...
class InstructBlipVideoQFormerConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import InstructBlipVideoQFormerConfig, InstructBlipVideoQFormerModel
