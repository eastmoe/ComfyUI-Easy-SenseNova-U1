...
class FlaxMT5Model(FlaxT5Model):
    ...
    ```python
    >>> from transformers_4571 import FlaxMT5Model, AutoTokenizer
...
class FlaxMT5EncoderModel(FlaxT5EncoderModel):
    ...
    ```python
    >>> from transformers_4571 import FlaxT5EncoderModel, AutoTokenizer
...
class FlaxMT5ForConditionalGeneration(FlaxT5ForConditionalGeneration):
    ...
    ```python
    >>> from transformers_4571 import FlaxMT5ForConditionalGeneration, AutoTokenizer
