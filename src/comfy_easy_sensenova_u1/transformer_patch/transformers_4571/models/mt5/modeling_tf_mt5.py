...
class TFMT5Model(TFT5Model):
    ...
    ```python
    >>> from transformers_4571 import TFMT5Model, AutoTokenizer
...
class TFMT5ForConditionalGeneration(TFT5ForConditionalGeneration):
    ...
    ```python
    >>> from transformers_4571 import TFMT5ForConditionalGeneration, AutoTokenizer
...
class TFMT5EncoderModel(TFT5EncoderModel):
    ...
    ```python
    >>> from transformers_4571 import TFMT5EncoderModel, AutoTokenizer
