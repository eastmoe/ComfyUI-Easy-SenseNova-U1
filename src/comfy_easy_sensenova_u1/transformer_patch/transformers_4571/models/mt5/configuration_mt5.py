...
class MT5OnnxConfig(OnnxSeq2SeqConfigWithPast):
    @property
    # Copied from transformers_4571.models.t5.configuration_t5.T5OnnxConfig.inputs
    ...
    @property
    # Copied from transformers_4571.models.t5.configuration_t5.T5OnnxConfig.default_onnx_opset
