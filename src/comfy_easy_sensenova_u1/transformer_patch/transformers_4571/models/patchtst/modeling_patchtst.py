...
# Copied from transformers_4571.models.wav2vec2.modeling_wav2vec2.Wav2Vec2Attention with Wav2Vec2->PatchTST
...
# Copied from transformers_4571.models.time_series_transformer.modeling_time_series_transformer.TimeSeriesStdScaler with TimeSeriesTransformer->PatchTST,TimeSeries->PatchTST
...
# Copied from transformers_4571.models.time_series_transformer.modeling_time_series_transformer.TimeSeriesMeanScaler with TimeSeriesTransformer->PatchTST,TimeSeries->PatchTST
...
# Copied from transformers_4571.models.time_series_transformer.modeling_time_series_transformer.TimeSeriesNOPScaler with TimeSeriesTransformer->PatchTST,TimeSeries->PatchTST
...
class PatchTSTModel(PatchTSTPreTrainedModel):
    ...
    def forward(
        ...
        >>> import torch
        >>> from transformers_4571 import PatchTSTModel
...
class PatchTSTForPretraining(PatchTSTPreTrainedModel):
    ...
    def forward(
        ...
        >>> from huggingface_hub import hf_hub_download
        >>> import torch
        >>> from transformers_4571 import PatchTSTConfig, PatchTSTForPretraining
...
class PatchTSTForClassification(PatchTSTPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import PatchTSTConfig, PatchTSTForClassification
...
class PatchTSTForPrediction(PatchTSTPreTrainedModel):
    ...
    def forward(
        ...
        >>> from huggingface_hub import hf_hub_download
        >>> import torch
        >>> from transformers_4571 import PatchTSTConfig, PatchTSTForPrediction
...
class PatchTSTForRegression(PatchTSTPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import PatchTSTConfig, PatchTSTForRegression
