...
# Copied from transformers_4571.models.bart.modeling_flax_bart.FlaxBartAttention with Bart->MBart
...
# Copied from transformers_4571.models.bart.modeling_flax_bart.FlaxBartEncoderLayerCollection with Bart->MBart
...
# Copied from transformers_4571.models.bart.modeling_flax_bart.FlaxBartDecoderLayerCollection with Bart->MBart
...
# Copied from transformers_4571.models.bart.modeling_flax_bart.FlaxBartClassificationHead with Bart->MBart
...
# Copied from transformers_4571.models.bart.modeling_flax_bart.FlaxBartModule with Bart->MBart
...
class FlaxMBartPreTrainedModel(FlaxPreTrainedModel):
    ...
    # Copied from transformers_4571.models.bart.modeling_flax_bart.FlaxBartPreTrainedModel.init_cache with Bart->MBart
    ...
    def encode(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, FlaxMBartForConditionalGeneration
...
# Copied from transformers_4571.models.bart.modeling_flax_bart.FlaxBartForConditionalGenerationModule with Bart->MBart
...
FLAX_MBART_CONDITIONAL_GENERATION_DOCSTRING = r"""
    ...
    ```python
    >>> from transformers_4571 import AutoTokenizer, FlaxMBartForConditionalGeneration, MBartConfig
...
# Copied from transformers_4571.models.bart.modeling_flax_bart.FlaxBartForSequenceClassificationModule with Bart->MBart
...
# Copied from transformers_4571.models.bart.modeling_flax_bart.FlaxBartForQuestionAnsweringModule with Bart->MBart
