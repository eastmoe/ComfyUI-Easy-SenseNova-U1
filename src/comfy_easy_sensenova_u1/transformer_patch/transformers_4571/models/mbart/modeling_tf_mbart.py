...
# Copied from transformers_4571.models.bart.modeling_tf_bart.TFBartLearnedPositionalEmbedding with Bart->MBart
...
# Copied from transformers_4571.models.bart.modeling_tf_bart.TFBartAttention with Bart->MBart
...
MBART_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from transformers_4571 import AutoTokenizer, TFMBartForConditionalGeneration
