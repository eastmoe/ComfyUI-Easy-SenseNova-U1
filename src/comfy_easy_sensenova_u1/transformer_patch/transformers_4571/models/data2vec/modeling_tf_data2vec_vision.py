...
# Copied from transformers_4571.models.vit.modeling_tf_vit.TFViTIntermediate with ViT->Data2VecVision
...
class TFData2VecVisionForSemanticSegmentation(TFData2VecVisionPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from transformers_4571 import AutoImageProcessor, TFData2VecVisionForSemanticSegmentation
