...
# Copied from transformers_4571.models.bert.modeling_bert.BertIntermediate with Bert->CPMAnt
...
# Copied from transformers_4571.models.bert.modeling_bert.BertOutput with Bert->CPMAnt
...
class CpmAntForCausalLM(CpmAntPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_4571 import CPMAntTokenizer, CpmAntForCausalLM
