...
class ClvpTokenizer(PreTrainedTokenizer):
    ...
    ```python
    >>> from transformers_4571 import ClvpTokenizer
    ...
    # Copied from transformers_4571.models.llama.tokenization_llama.LlamaTokenizer.build_inputs_with_special_tokens
    ...
    # Copied from transformers_4571.models.gpt2.tokenization_gpt2.GPT2Tokenizer.get_special_tokens_mask
