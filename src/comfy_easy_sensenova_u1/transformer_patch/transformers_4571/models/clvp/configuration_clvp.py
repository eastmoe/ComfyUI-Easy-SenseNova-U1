...
class ClvpEncoderConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import ClvpEncoderConfig, ClvpEncoder
...
class ClvpDecoderConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import ClvpDecoderConfig, ClvpDecoder
...
class ClvpConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import ClvpConfig, ClvpModelForConditionalGeneration
    ...
    >>> from transformers_4571 import ClvpEncoderConfig, ClvpDecoderConfig
