...
class ClapTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import ClapTextConfig, ClapTextModel
...
class ClapAudioConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import ClapAudioConfig, ClapAudioModel
...
class ClapConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import ClapConfig, ClapModel
    ...
    >>> from transformers_4571 import ClapTextConfig, ClapAudioConfig
