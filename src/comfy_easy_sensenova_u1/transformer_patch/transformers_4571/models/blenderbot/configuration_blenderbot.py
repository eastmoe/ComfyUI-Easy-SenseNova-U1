...
class BlenderbotConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import BlenderbotConfig, BlenderbotModel
...
class BlenderbotOnnxConfig(OnnxSeq2SeqConfigWithPast):
    ...
    @property
    # Copied from transformers_4571.models.bart.configuration_bart.BartOnnxConfig.outputs
    ...
    # Copied from transformers_4571.models.bart.configuration_bart.BartOnnxConfig._generate_dummy_inputs_for_sequence_classification_and_question_answering
    ...
    # Copied from transformers_4571.models.bart.configuration_bart.BartOnnxConfig.generate_dummy_inputs
    ...
    # Copied from transformers_4571.models.bart.configuration_bart.BartOnnxConfig._flatten_past_key_values_
