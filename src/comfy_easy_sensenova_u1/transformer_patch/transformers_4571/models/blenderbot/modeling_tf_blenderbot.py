...
# Copied from transformers_4571.models.bart.modeling_tf_bart.TFBartAttention with Bart->Blenderbot
...
# Copied from transformers_4571.models.mbart.modeling_tf_mbart.TFMBartEncoderLayer with MBart->Blenderbot
...
# Copied from transformers_4571.models.mbart.modeling_tf_mbart.TFMBartDecoderLayer with MBart->Blenderbot
...
BLENDERBOT_GENERATION_EXAMPLE = r"""
    ...
    ```py
    >>> from transformers_4571 import AutoTokenizer, TFBlenderbotForConditionalGeneration
