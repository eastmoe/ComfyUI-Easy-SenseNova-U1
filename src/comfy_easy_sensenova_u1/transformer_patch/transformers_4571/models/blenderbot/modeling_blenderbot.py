...
# Copied from transformers_4571.models.bart.modeling_bart.BartScaledWordEmbedding with Bart->Blenderbot
...
# Copied from transformers_4571.models.bart.modeling_bart.BartAttention with Bart->Blenderbot
...
# Copied from transformers_4571.models.mbart.modeling_mbart.MBartEncoderLayer with MBart->Blenderbot, MBART->BLENDERBOT
...
# Copied from transformers_4571.models.mbart.modeling_mbart.MBartDecoderLayer with MBart->Blenderbot, MBART->BLENDERBOT
...
class BlenderbotModel(BlenderbotPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, BlenderbotModel
...
class BlenderbotForConditionalGeneration(BlenderbotPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, BlenderbotForConditionalGeneration
...
# Copied from transformers_4571.models.bart.modeling_bart.BartDecoderWrapper with Bart->Blenderbot
...
# Copied from transformers_4571.models.bart.modeling_bart.BartForCausalLM with Bart->Blenderbot, facebook/bart-base->facebook/blenderbot-400M-distill
class BlenderbotForCausalLM(BlenderbotPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, BlenderbotForCausalLM
