...
from transformers_4571.models.llama4.configuration_llama4 import Llama4VisionConfig
...
# Adapted from transformers_4571.models.llama.modeling_llama.eager_attention_forward -> llama4 doesn't cast attn weights to fp32
...
class Llama4ForCausalLM(Llama4PreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, Llama4ForCausalLM
...
class Llama4ForConditionalGeneration(Llama4PreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, LlavaForConditionalGeneration
