...
# Copied from transformers_4571.models.blip_2.modeling_blip_2.Blip2ForConditionalGenerationModelOutput with Blip2->InstructBlip
...
# Copied from transformers_4571.models.blip.modeling_blip.BlipVisionEmbeddings with Blip->InstructBlip
...
# Adapted from transformers_4571.models.siglip.modeling_siglip.eager_attention_forward -> InstructBLIP doesn't cast attn weights to fp32
...
# Copied from transformers_4571.models.blip_2.modeling_blip_2.Blip2Attention with Blip2->InstructBlip
...
# Copied from transformers_4571.models.blip.modeling_blip.BlipMLP
...
# Copied from transformers_4571.models.blip.modeling_blip.BlipEncoderLayer with Blip->InstructBlip
...
# Copied from transformers_4571.models.blip.modeling_blip.BlipEncoder with Blip->InstructBlip
...
# Copied from transformers_4571.models.blip.modeling_blip.BlipVisionModel with Blip->InstructBlip, BLIP->INSTRUCTBLIP
...
# Copied from transformers_4571.models.bert.modeling_bert.BertSelfOutput with Bert->InstructBlipQFormer
...
# Copied from transformers_4571.models.blip_2.modeling_blip_2.Blip2QFormerAttention with Blip2->InstructBlip
...
# Copied from transformers_4571.models.bert.modeling_bert.BertIntermediate with Bert->InstructBlipQFormer
...
# Copied from transformers_4571.models.bert.modeling_bert.BertOutput with Bert->InstructBlipQFormer
...
# Copied from transformers_4571.models.blip_2.modeling_blip_2.Blip2QFormerEncoder with Blip2->InstructBlip
...
class InstructBlipForConditionalGeneration(InstructBlipPreTrainedModel, GenerationMixin):
    ...
    # Copied from transformers_4571.models.instructblip.modeling_instructblip.InstructBlipModel._tie_weights
    def _tie_weights(self):
        if not self.config.use_decoder_only_language_model:
            self.language_model.encoder.embed_tokens = self.language_model.shared
            self.language_model.decoder.embed_tokens = self.language_model.shared

    # Copied from transformers_4571.models.instructblip.modeling_instructblip.InstructBlipModel._preprocess_accelerate
    def _preprocess_accelerate(self):
        r"""
        Some pre-processing hacks to make the model `accelerate` compatible. Check
        https://github.com/huggingface/transformers/pull/21707 for more details.
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        ```python
        >>> from transformers_4571 import InstructBlipProcessor, InstructBlipForConditionalGeneration
        >>> import torch
