...
class InstructBlipVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import InstructBlipVisionConfig, InstructBlipVisionModel
...
class InstructBlipQFormerConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import InstructBlipQFormerConfig, InstructBlipQFormerModel
