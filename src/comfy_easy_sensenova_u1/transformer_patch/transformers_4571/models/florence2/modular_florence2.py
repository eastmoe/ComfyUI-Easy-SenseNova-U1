...
class Florence2VisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import Florence2VisionConfig, Florence2VisionModel
...
class Florence2Config(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import Florence2ForConditionalGeneration, Florence2Config, CLIPVisionConfig, BartConfig
...
class Florence2ForConditionalGeneration(LlavaForConditionalGeneration):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, Florence2ForConditionalGeneration
