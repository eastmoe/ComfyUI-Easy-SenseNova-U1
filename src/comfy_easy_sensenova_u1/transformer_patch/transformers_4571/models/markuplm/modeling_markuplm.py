...
class MarkupLMEmbeddings(nn.Module):
    ...
    # Copied from transformers_4571.models.roberta.modeling_roberta.RobertaEmbeddings.create_position_ids_from_inputs_embeds
...
# Copied from transformers_4571.models.bert.modeling_bert.BertSelfOutput with Bert->MarkupLM
...
# Copied from transformers_4571.models.bert.modeling_bert.BertOutput with Bert->MarkupLM
...
# Copied from transformers_4571.models.bert.modeling_bert.BertPredictionHeadTransform with Bert->MarkupLM
...
# Copied from transformers_4571.models.bert.modeling_bert.BertLMPredictionHead with Bert->MarkupLM
...
# Copied from transformers_4571.models.bert.modeling_bert.BertOnlyMLMHead with Bert->MarkupLM
...
# Copied from transformers_4571.models.align.modeling_align.AlignTextSelfAttention with AlignText->MarkupLM
...
# Copied from transformers_4571.models.align.modeling_align.AlignTextAttention with AlignText->MarkupLM
...
# Copied from transformers_4571.models.align.modeling_align.AlignTextLayer with AlignText->MarkupLM
...
# Copied from transformers_4571.models.align.modeling_align.AlignTextEncoder with AlignText->MarkupLM
...
class MarkupLMPreTrainedModel(PreTrainedModel):
    ...
    # Copied from transformers_4571.models.bert.modeling_bert.BertPreTrainedModel._init_weights with Bert->MarkupLM
...
class MarkupLMModel(MarkupLMPreTrainedModel):
    # Copied from transformers_4571.models.clap.modeling_clap.ClapTextModel.__init__ with ClapText->MarkupLM
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoProcessor, MarkupLMModel
...
class MarkupLMForQuestionAnswering(MarkupLMPreTrainedModel):
    # Copied from transformers_4571.models.bert.modeling_bert.BertForQuestionAnswering.__init__ with bert->markuplm, Bert->MarkupLM
    def __init__(self, config):
        super().__init__(config)
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoProcessor, MarkupLMForQuestionAnswering
        >>> import torch
...
class MarkupLMForTokenClassification(MarkupLMPreTrainedModel):
    # Copied from transformers_4571.models.bert.modeling_bert.BertForTokenClassification.__init__ with bert->markuplm, Bert->MarkupLM
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoProcessor, AutoModelForTokenClassification
        >>> import torch
...
class MarkupLMForSequenceClassification(MarkupLMPreTrainedModel):
    # Copied from transformers_4571.models.bert.modeling_bert.BertForSequenceClassification.__init__ with bert->markuplm, Bert->MarkupLM
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
        self.config = config
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoProcessor, AutoModelForSequenceClassification
        >>> import torch
