...
@add_start_docstrings(
    ...
    ```python
    >>> from transformers_4571 import BarkSemanticConfig, BarkSemanticModel
...
@add_start_docstrings(
    ...
    ```python
    >>> from transformers_4571 import BarkCoarseConfig, BarkCoarseModel
...
@add_start_docstrings(
    ...
    ```python
    >>> from transformers_4571 import BarkFineConfig, BarkFineModel
