...
# Copied from transformers_4571.models.marian.modeling_marian.MarianSinusoidalPositionalEmbedding with Marian->TimeSeries
...
# Copied from transformers_4571.models.bart.modeling_bart.BartAttention with Bart->TimeSeriesTransformer
...
# Copied from transformers_4571.models.bart.modeling_bart.BartEncoderLayer with Bart->TimeSeriesTransformer, BART->TIME_SERIES_TRANSFORMER
...
# Copied from transformers_4571.models.bart.modeling_bart.BartDecoderLayer with Bart->TimeSeriesTransformer, with BART->TIME_SERIES_TRANSFORMER
...
class TimeSeriesTransformerModel(TimeSeriesTransformerPreTrainedModel):
    ...
    def forward(
        ...
        >>> import torch
        >>> from transformers_4571 import TimeSeriesTransformerModel
...
class TimeSeriesTransformerForPrediction(TimeSeriesTransformerPreTrainedModel):
    ...
    def forward(
        ...
        >>> from huggingface_hub import hf_hub_download
        >>> import torch
        >>> from transformers_4571 import TimeSeriesTransformerForPrediction
