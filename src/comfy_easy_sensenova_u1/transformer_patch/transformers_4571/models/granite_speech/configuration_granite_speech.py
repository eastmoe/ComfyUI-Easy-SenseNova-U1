...
class GraniteSpeechEncoderConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import GraniteSpeechEncoderConfig, GraniteSpeechCTCEncoder
...
class GraniteSpeechConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import GraniteSpeechConfig, GraniteSpeechForConditionalGeneration
