...
class TFDPRContextEncoder(TFDPRPretrainedContextEncoder):
    ...
    def call(
        ...
        ```python
        >>> from transformers_4571 import TFDPRContextEncoder, DPRContextEncoderTokenizer
...
class TFDPRQuestionEncoder(TFDPRPretrainedQuestionEncoder):
    ...
    def call(
        ...
        ```python
        >>> from transformers_4571 import TFDPRQuestionEncoder, DPRQuestionEncoderTokenizer
...
class TFDPRReader(TFDPRPretrainedReader):
    ...
    def call(
        ...
        ```python
        >>> from transformers_4571 import TFDPRReader, DPRReaderTokenizer
