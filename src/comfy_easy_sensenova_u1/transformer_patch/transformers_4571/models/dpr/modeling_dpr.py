...
class DPRContextEncoder(DPRPretrainedContextEncoder):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import DPRContextEncoder, DPRContextEncoderTokenizer
...
class DPRQuestionEncoder(DPRPretrainedQuestionEncoder):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import DPRQuestionEncoder, DPRQuestionEncoderTokenizer
...
class DPRReader(DPRPretrainedReader):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import DPRReader, DPRReaderTokenizer
