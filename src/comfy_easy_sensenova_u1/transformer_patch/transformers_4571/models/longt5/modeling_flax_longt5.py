...
# Copied from transformers_4571.models.bart.modeling_flax_bart.shift_tokens_right
...
# Copied from transformers_4571.models.t5.modeling_flax_t5.FlaxT5LayerNorm with T5->LongT5
...
# Copied from transformers_4571.models.t5.modeling_flax_t5.FlaxT5DenseActDense with T5->LongT5
...
# Copied from transformers_4571.models.t5.modeling_flax_t5.FlaxT5DenseGatedActDense with T5->LongT5
...
# Copied from transformers_4571.models.t5.modeling_flax_t5.FlaxT5LayerFF with T5->LongT5
...
# Copied from transformers_4571.models.t5.modeling_flax_t5.FlaxT5Attention with T5->LongT5
...
class FlaxLongT5LocalAttention(nn.Module):
    ...
    @staticmethod
    # Copied from transformers_4571.models.t5.modeling_flax_t5.FlaxT5Attention._relative_position_bucket
    def _relative_position_bucket(relative_position, bidirectional=True, num_buckets=32, max_distance=128):
        """
        Adapted from Mesh Tensorflow:
        https://github.com/tensorflow/mesh/blob/0cb87fe07da627bf0b7e60475d59f95ed6b5be3d/mesh_tensorflow/transformer/transformer_layers.py#L593
...
# Copied from transformers_4571.models.t5.modeling_flax_t5.FlaxT5LayerSelfAttention with T5->LongT5
...
# Copied from transformers_4571.models.t5.modeling_flax_t5.FlaxT5LayerCrossAttention with T5->LongT5
...
class FlaxLongT5Block(nn.Module):
    ...
    # Copied from transformers_4571.models.t5.modeling_flax_t5.FlaxT5Block.__call__ with T5->LongT5
    def __call__(
        self,
        hidden_states,
        attention_mask=None,
...
# Copied from transformers_4571.models.t5.modeling_flax_t5.FlaxT5LayerCollection with T5->LongT5
...
# Copied from transformers_4571.models.t5.modeling_flax_t5.FlaxT5BlockCollection with T5->LongT5
...
# Copied from transformers_4571.models.t5.modeling_flax_t5.FlaxT5Stack with T5->LongT5
...
class FlaxLongT5PreTrainedModel(FlaxPreTrainedModel):
    ...
    def encode(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, FlaxLongT5ForConditionalGeneration
...
# Copied from transformers_4571.models.t5.modeling_flax_t5.FlaxT5Module with T5->LongT5
...
# Copied from transformers_4571.models.t5.modeling_flax_t5.FlaxT5Model with T5->LongT5
...
FLAX_LONGT5_MODEL_DOCSTRING = """
    ...
    ```python
    >>> from transformers_4571 import AutoTokenizer, FlaxLongT5Model
...
# Copied from transformers_4571.models.t5.modeling_flax_t5.FlaxT5ForConditionalGenerationModule with T5->LongT5
