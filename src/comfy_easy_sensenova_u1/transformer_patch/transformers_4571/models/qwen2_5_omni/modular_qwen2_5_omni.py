...
from transformers_4571.models.llama.modeling_llama import rotate_half
from transformers_4571.models.qwen2_5_vl.configuration_qwen2_5_vl import Qwen2_5_VLVisionConfig
from transformers_4571.models.qwen2_5_vl.modeling_qwen2_5_vl import (
...
from transformers_4571.models.qwen2_audio.configuration_qwen2_audio import Qwen2AudioEncoderConfig
from transformers_4571.models.qwen2_audio.modeling_qwen2_audio import Qwen2AudioEncoderLayer
from transformers_4571.models.qwen2_vl.modeling_qwen2_vl import Qwen2VLRotaryEmbedding
...
class Qwen2_5OmniVisionEncoderConfig(Qwen2_5_VLVisionConfig):
    ...
    ```python
    >>> from transformers_4571 import Qwen2_5OmniVisionEncoderConfig, Qwen2_5OmniVisionEncoder
...
class Qwen2_5OmniAudioEncoderConfig(Qwen2AudioEncoderConfig):
    ...
    ```python
    >>> from transformers_4571 import Qwen2_5OmniAudioEncoderConfig, Qwen2_5OmniAudioEncoder
...
class Qwen2_5OmniTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import Qwen2_5OmniThinkerForConditionalGeneration, Qwen2_5OmniThinkerConfig, Qwen2_5OmniAudioEncoderConfig, Qwen2_5OmniVisionEncoderConfig
...
class Qwen2_5OmniTalkerConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import Qwen2_5OmniTalkerForConditionalGeneration, Qwen2_5OmniThinkerConfig, Qwen2_5OmniAudioEncoderConfig, Qwen2_5OmniVisionEncoderConfig
...
class Qwen2_5OmniToken2WavConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import Qwen2_5OmniToken2WavModel, DiT_Args, BigVGAN_Args
...
class Qwen2_5OmniThinkerForConditionalGeneration(Qwen2_5OmniPreTrainedModelForConditionalGeneration, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> from transformers_4571 import Qwen2_5OmniProcessor, Qwen2_5OmniThinkerForConditionalGeneration
...
class Qwen2_5OmniTalkerForConditionalGeneration(Qwen2_5OmniPreTrainedModelForConditionalGeneration, GenerationMixin):
    ...
    def forward(
        ...
        >>> from urllib.request import urlopen
        >>> import librosa
        >>> from transformers_4571 import AutoProcessor, Qwen2_5OmniTalkerForConditionalGeneration
