...
class Idefics2VisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571.models.idefics2.modeling_idefics2 import Idefics2VisionTransformer
    >>> from transformers_4571.models.idefics2.configuration_idefics2 import Idefics2VisionConfig
...
class Idefics2Config(PretrainedConfig):
    ...
    Example:
    ```python
    >>> from transformers_4571 import Idefics2Model, Idefics2Config
