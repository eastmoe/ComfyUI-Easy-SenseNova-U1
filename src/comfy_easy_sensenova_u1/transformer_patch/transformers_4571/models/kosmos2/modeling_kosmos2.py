...
# Copied from transformers_4571.models.clip.modeling_clip.CLIPVisionEmbeddings with CLIP->Kosmos2
...
# Adapted from transformers_4571.models.siglip.modeling_siglip.eager_attention_forward -> Kosmos2 doesn't cast attn weights to fp32
...
# Copied from transformers_4571.models.clip.modeling_clip.CLIPMLP with CLIP->Kosmos2Vision
...
# Copied from transformers_4571.models.altclip.modeling_altclip.AltCLIPEncoderLayer with AltCLIP->Kosmos2Vision
...
# Copied from transformers_4571.models.altclip.modeling_altclip.AltCLIPEncoder with AltCLIP->Kosmos2Vision
...
class Kosmos2VisionTransformer(nn.Module):
    # Copied from transformers_4571.models.altclip.modeling_altclip.AltCLIPVisionTransformer.__init__ with AltCLIPVision->Kosmos2Vision,ALTCLIP_VISION->KOSMOS2_VISION,AltCLIP->Kosmos2Vision
    def __init__(self, config: Kosmos2VisionConfig):
        super().__init__()
        self.config = config
...
class Kosmos2VisionModel(Kosmos2PreTrainedModel):
    ...
    # Copied from transformers_4571.models.clip.modeling_clip.CLIPVisionModel.__init__ with CLIP_VISION->KOSMOS2_VISION,CLIP->Kosmos2,self.vision_model->self.model
    def __init__(self, config: Kosmos2VisionConfig):
    ...
    # Copied from transformers_4571.models.clip.modeling_clip.CLIPVisionModel.get_input_embeddings with CLIP_VISION->KOSMOS2_VISION,CLIP->Kosmos2,self.vision_model->self.model
...
class Kosmos2Model(Kosmos2PreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, Kosmos2Model
...
class Kosmos2ForConditionalGeneration(Kosmos2PreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, Kosmos2ForConditionalGeneration
