...
from transformers_4571.utils.generic import OutputRecorder, TransformersKwargs, check_model_inputs
...
# Copied from transformers_4571.models.convnext.modeling_convnext.ConvNextLayerNorm with ConvNext->Sam
...
class SamModel(SamPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> import requests
        >>> from transformers_4571 import AutoModel, AutoProcessor
