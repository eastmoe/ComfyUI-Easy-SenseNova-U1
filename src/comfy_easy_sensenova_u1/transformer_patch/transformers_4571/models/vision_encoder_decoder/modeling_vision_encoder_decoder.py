...
# Copied from transformers_4571.models.encoder_decoder.modeling_encoder_decoder.shift_tokens_right
...
class VisionEncoderDecoderModel(PreTrainedModel, GenerationMixin):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        ```python
        >>> from transformers_4571 import VisionEncoderDecoderModel, AutoImageProcessor, AutoTokenizer
        ...
        if from_tf:
            from transformers_4571 import TFVisionEncoderDecoderModel
    ...
    def from_encoder_decoder_pretrained(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_4571 import VisionEncoderDecoderModel
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_4571 import AutoProcessor, VisionEncoderDecoderModel
        >>> import requests
        >>> from PIL import Image
        >>> import torch
