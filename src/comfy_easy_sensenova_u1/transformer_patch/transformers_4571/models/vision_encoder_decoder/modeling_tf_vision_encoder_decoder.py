...
# Copied from transformers_4571.models.encoder_decoder.modeling_tf_encoder_decoder.shift_tokens_right
...
class TFVisionEncoderDecoderModel(TFPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def call(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_4571 import AutoImageProcessor, AutoTokenizer, TFVisionEncoderDecoderModel
