...
class CLIPSegTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import CLIPSegTextConfig, CLIPSegTextModel
...
class CLIPSegVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import CLIPSegVisionConfig, CLIPSegVisionModel
...
class CLIPSegConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import CLIPSegConfig, CLIPSegModel
