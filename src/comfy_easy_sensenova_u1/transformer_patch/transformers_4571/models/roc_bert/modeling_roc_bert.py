...
# Copied from transformers_4571.models.bert.modeling_bert.load_tf_weights_in_bert with bert->roc_bert
...
# Copied from transformers_4571.models.bert.modeling_bert.BertSelfAttention with Bert->RoCBert
...
# Copied from transformers_4571.models.bert.modeling_bert.BertSelfOutput with Bert->RoCBert
...
# Copied from transformers_4571.models.bert.modeling_bert.BertAttention with Bert->RoCBert,BERT->ROC_BERT
...
# Copied from transformers_4571.models.bert.modeling_bert.BertIntermediate with Bert->RoCBert
...
# Copied from transformers_4571.models.bert.modeling_bert.BertOutput with Bert->RoCBert
...
# Copied from transformers_4571.models.bert.modeling_bert.BertLayer with Bert->RoCBert
...
# Copied from transformers_4571.models.bert.modeling_bert.BertEncoder with Bert->RoCBert
...
# Copied from transformers_4571.models.bert.modeling_bert.BertPooler with Bert->RoCBert
...
# Copied from transformers_4571.models.bert.modeling_bert.BertPredictionHeadTransform with Bert->RoCBert
...
# Copied from transformers_4571.models.bert.modeling_bert.BertLMPredictionHead with Bert->RoCBert
...
# Copied from transformers_4571.models.bert.modeling_bert.BertOnlyMLMHead with Bert->RoCBert
...
class RoCBertModel(RoCBertPreTrainedModel):
    # Copied from transformers_4571.models.clap.modeling_clap.ClapTextModel.__init__ with ClapText->RoCBert
...
class RoCBertForPreTraining(RoCBertPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, RoCBertForPreTraining
        >>> import torch
...
class RoCBertForMaskedLM(RoCBertPreTrainedModel):
    ...
    # Copied from transformers_4571.models.bert.modeling_bert.BertForMaskedLM.__init__ with Bert->RoCBert,bert->roc_bert
    def __init__(self, config):
        super().__init__(config)
    ...
    def forward(
        ...
        Example:
        ```python
        >>> from transformers_4571 import AutoTokenizer, RoCBertForMaskedLM
        >>> import torch
...
class RoCBertForCausalLM(RoCBertPreTrainedModel, GenerationMixin):
    ...
    # Copied from transformers_4571.models.bert.modeling_bert.BertLMHeadModel.__init__ with BertLMHeadModel->RoCBertForCausalLM,Bert->RoCBert,bert->roc_bert
    def __init__(self, config):
        super().__init__(config)
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, RoCBertForCausalLM, RoCBertConfig
        >>> import torch
...
class RoCBertForSequenceClassification(RoCBertPreTrainedModel):
    # Copied from transformers_4571.models.bert.modeling_bert.BertForSequenceClassification.__init__ with Bert->RoCBert,bert->roc_bert
    def __init__(self, config):
        super().__init__(config)
...
class RoCBertForMultipleChoice(RoCBertPreTrainedModel):
    # Copied from transformers_4571.models.bert.modeling_bert.BertForMultipleChoice.__init__ with Bert->RoCBert,bert->roc_bert
    def __init__(self, config):
        super().__init__(config)
...
class RoCBertForTokenClassification(RoCBertPreTrainedModel):
    # Copied from transformers_4571.models.bert.modeling_bert.BertForTokenClassification.__init__ with Bert->RoCBert,bert->roc_bert
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
...
class RoCBertForQuestionAnswering(RoCBertPreTrainedModel):
    # Copied from transformers_4571.models.bert.modeling_bert.BertForQuestionAnswering.__init__ with Bert->RoCBert,bert->roc_bert
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
