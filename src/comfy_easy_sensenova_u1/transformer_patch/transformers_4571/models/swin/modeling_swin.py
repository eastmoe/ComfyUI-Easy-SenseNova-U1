...
# Copied from transformers_4571.models.beit.modeling_beit.BeitDropPath with Beit->Swin
...
class SwinForMaskedImageModeling(SwinPreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from transformers_4571 import AutoImageProcessor, SwinForMaskedImageModeling
        >>> import torch
