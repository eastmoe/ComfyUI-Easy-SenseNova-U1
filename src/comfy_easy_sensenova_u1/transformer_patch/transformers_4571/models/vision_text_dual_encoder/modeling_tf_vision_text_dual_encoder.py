...
# Copied from transformers_4571.models.clip.modeling_tf_clip.clip_loss
...
class TFVisionTextDualEncoderModel(TFPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from transformers_4571 import TFVisionTextDualEncoderModel, AutoTokenizer
    ...
    def get_image_features(
        ...
        >>> import requests
        >>> from transformers_4571 import TFVisionTextDualEncoderModel, AutoImageProcessor
    ...
    def from_vision_text_pretrained(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_4571 import TFVisionTextDualEncoderModel
