...
class PerceiverModel(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import PerceiverConfig, PerceiverTokenizer, PerceiverImageProcessor, PerceiverModel
        >>> from transformers_4571.models.perceiver.modeling_perceiver import (
...
class PerceiverForMaskedLM(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, PerceiverForMaskedLM
        >>> import torch
...
class PerceiverForSequenceClassification(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, PerceiverForSequenceClassification
...
class PerceiverForImageClassificationLearned(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoImageProcessor, PerceiverForImageClassificationLearned
        >>> from PIL import Image
        >>> import requests
...
class PerceiverForImageClassificationFourier(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoImageProcessor, PerceiverForImageClassificationFourier
        >>> from PIL import Image
        >>> import requests
...
class PerceiverForImageClassificationConvProcessing(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoImageProcessor, PerceiverForImageClassificationConvProcessing
        >>> from PIL import Image
        >>> import requests
...
class PerceiverForOpticalFlow(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import PerceiverForOpticalFlow
        >>> import torch
...
class PerceiverForMultimodalAutoencoding(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import PerceiverForMultimodalAutoencoding
        >>> import torch
        >>> import numpy as np
