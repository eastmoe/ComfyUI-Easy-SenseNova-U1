...
class AlignTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import AlignTextConfig, AlignTextModel
...
class AlignVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import AlignVisionConfig, AlignVisionModel
...
class AlignConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import AlignConfig, AlignModel
    ...
    >>> from transformers_4571 import AlignTextConfig, AlignVisionConfig
