...
# Copied from transformers_4571.models.clip.modeling_clip.CLIPVisionModelOutput with CLIP->Git
...
# Copied from transformers_4571.models.clip.modeling_clip.CLIPVisionEmbeddings with CLIP->Git
...
# Copied from transformers_4571.models.altclip.modeling_altclip.AltCLIPEncoderLayer with AltCLIP->GitVision
...
# Copied from transformers_4571.models.altclip.modeling_altclip.AltCLIPEncoder with AltCLIP->GitVision, CLIPConfig
...
class GitVisionTransformer(nn.Module):
    # Copied from transformers_4571.models.altclip.modeling_altclip.AltCLIPVisionTransformer.__init__ with AltCLIPEncoder->GitVisionEncoder, AltCLIP->Git
    def __init__(self, config: GitVisionConfig):
        super().__init__()
        self.config = config
...
class GitVisionModel(GitPreTrainedModel):
    ...
    # Copied from transformers_4571.models.clip.modeling_clip.CLIPVisionModel.__init__ with CLIP->Git
    def __init__(self, config: GitVisionConfig):
    ...
    def forward(
        ...
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, GitVisionModel
...
class GitForCausalLM(GitPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_4571 import AutoProcessor, AutoModelForCausalLM
        >>> import requests
        >>> from PIL import Image
