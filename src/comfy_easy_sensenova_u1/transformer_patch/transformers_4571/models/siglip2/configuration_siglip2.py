...
class Siglip2TextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import Siglip2TextConfig, Siglip2TextModel
...
class Siglip2Config(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import Siglip2Config, Siglip2Model
    ...
    >>> from transformers_4571 import Siglip2TextConfig, Siglip2VisionConfig
