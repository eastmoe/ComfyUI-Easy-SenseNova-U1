...
from transformers_4571.models.siglip.configuration_siglip import SiglipConfig, SiglipTextConfig, SiglipVisionConfig
from transformers_4571.models.siglip.modeling_siglip import (
    BaseModelOutput,
...
class Siglip2VisionConfig(SiglipVisionConfig):
    ...
    ```python
    >>> from transformers_4571 import Siglip2VisionConfig, Siglip2VisionModel
...
class Siglip2VisionModel(SiglipVisionModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, Siglip2VisionModel
...
class Siglip2ForImageClassification(SiglipForImageClassification):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoImageProcessor, Siglip2ForImageClassification
        >>> import torch
        >>> from PIL import Image
        >>> import requests
