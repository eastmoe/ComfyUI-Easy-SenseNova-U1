...
class OwlViTImageProcessorFast(BaseImageProcessorFast):
    ...
    # Copied from transformers_4571.models.owlvit.image_processing_owlvit.OwlViTImageProcessor.post_process
    ...
    # Copied from transformers_4571.models.owlvit.image_processing_owlvit.OwlViTImageProcessor.post_process_object_detection
