...
# Copied from transformers_4571.models.mixtral.modeling_mixtral.MixtralBlockSparseTop2MLP with Mixtral->Phimoe
...
class PhimoeForCausalLM(PhimoePreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        Example:
        ```python
        >>> from transformers_4571 import AutoTokenizer, PhimoeForCausalLM
    ...
    # Copied from transformers_4571.models.phi3.modeling_phi3.Phi3ForCausalLM.prepare_inputs_for_generation
