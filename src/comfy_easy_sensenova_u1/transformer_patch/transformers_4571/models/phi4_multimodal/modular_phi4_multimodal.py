...
class Phi4MultimodalVisionConfig(SiglipVisionConfig):
    ...
    ```python
    >>> from transformers_4571 import Phi4MultimodalVisionConfig
...
class Phi4MultimodalAudioConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import Phi4MultimodalAudioConfig
...
class Phi4MultimodalConfig(Phi3Config):
    ...
    ```python
    >>> from transformers_4571 import Phi4MultimodalModel, Phi4MultimodalConfig
...
class Phi4MultimodalForCausalLM(Phi3ForCausalLM):
    ...
    def forward(
        ...
        **kwargs,
        ...
        Example:
        ```python
        >>> from transformers_4571 import AutoTokenizer, Phi4MultimodalForCausalLM
