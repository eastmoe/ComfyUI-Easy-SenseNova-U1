...
class FlaxDinov2PatchEmbeddings(nn.Module):
    ...
    # Copied from transformers_4571.models.vit.modeling_flax_vit.FlaxViTPatchEmbeddings.__call__
...
# Copied from transformers_4571.models.vit.modeling_flax_vit.FlaxViTSelfAttention with ViT->Dinov2
...
# Copied from transformers_4571.models.vit.modeling_flax_vit.FlaxViTSelfOutput with ViT->Dinov2
...
# Copied from transformers_4571.models.vit.modeling_flax_vit.FlaxViTAttention with ViT->Dinov2
...
# Copied from transformers_4571.models.beit.modeling_flax_beit.FlaxBeitDropPath with Beit -> Dinov2
...
# Copied from transformers_4571.models.vit.modeling_flax_vit.FlaxViTLayerCollection with ViT->Dinov2
...
# Copied from transformers_4571.models.vit.modeling_flax_vit.FlaxViTEncoder with ViT->Dinov2
...
FLAX_VISION_MODEL_DOCSTRING = """
    ...
    ```python
    >>> from transformers_4571 import AutoImageProcessor, FlaxDinov2Model
...
FLAX_VISION_CLASSIFICATION_DOCSTRING = """
    ...
    ```python
    >>> from transformers_4571 import AutoImageProcessor, FlaxDinov2ForImageClassification
    >>> from PIL import Image
    >>> import jax
    >>> import requests
