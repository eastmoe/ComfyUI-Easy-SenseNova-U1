...
from transformers_4571.models.aya_vision.modeling_aya_vision import (
    AyaVisionCausalLMOutputWithPast,
    AyaVisionForConditionalGeneration,
    AyaVisionModel,
    AyaVisionModelOutputWithPast,
)
from transformers_4571.models.got_ocr2.image_processing_got_ocr2_fast import GotOcr2ImageProcessorFast
...
class Cohere2VisionForConditionalGeneration(AyaVisionForConditionalGeneration):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        ```python
        >>> from transformers_4571 import AutoProcessor, Cohere2VisionForConditionalGeneration
        >>> import torch
