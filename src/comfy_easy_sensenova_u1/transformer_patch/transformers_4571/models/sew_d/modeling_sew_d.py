...
@torch.jit.script
# Copied from transformers_4571.models.deberta.modeling_deberta.c2p_dynamic_expand
def c2p_dynamic_expand(c2p_pos, query_layer, relative_pos):
    return c2p_pos.expand([query_layer.size(0), query_layer.size(1), query_layer.size(2), relative_pos.size(-1)])


@torch.jit.script
# Copied from transformers_4571.models.deberta.modeling_deberta.p2c_dynamic_expand
def p2c_dynamic_expand(c2p_pos, query_layer, key_layer):
    return c2p_pos.expand([query_layer.size(0), query_layer.size(1), key_layer.size(-2), key_layer.size(-2)])


@torch.jit.script
# Copied from transformers_4571.models.deberta.modeling_deberta.pos_dynamic_expand
...
# Copied from transformers_4571.models.wav2vec2.modeling_wav2vec2.Wav2Vec2NoLayerNormConvLayer with Wav2Vec2->SEWD
...
# Copied from transformers_4571.models.wav2vec2.modeling_wav2vec2.Wav2Vec2LayerNormConvLayer with Wav2Vec2->SEWD
...
# Copied from transformers_4571.models.wav2vec2.modeling_wav2vec2.Wav2Vec2GroupNormConvLayer with Wav2Vec2->SEWD
...
# Copied from transformers_4571.models.sew.modeling_sew.SEWPositionalConvEmbedding with SEW->SEWD
...
# Copied from transformers_4571.models.wav2vec2.modeling_wav2vec2.Wav2Vec2SamePadLayer with Wav2Vec2->SEW
...
# Copied from transformers_4571.models.sew.modeling_sew.SEWUpsampling with SEW->SEWD
...
# Copied from transformers_4571.models.wav2vec2.modeling_wav2vec2.Wav2Vec2FeatureEncoder with Wav2Vec2->SEWD
...
class XSoftmax(torch.autograd.Function):
    ...
    ```python
    >>> import torch
    >>> from transformers_4571.models.deberta_v2.modeling_deberta_v2 import XSoftmax
...
# Copied from transformers_4571.models.bert.modeling_bert.BertIntermediate with Bert->SEWD
...
@auto_docstring
# Copied from transformers_4571.models.sew.modeling_sew.SEWModel with SEW->SEWD, layer_norm_eps->feature_layer_norm_eps
...
# Copied from transformers_4571.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForCTC with Wav2Vec2->SEWD, wav2vec2->sew_d, WAV2VEC2->SEWD
...
# Copied from transformers_4571.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForSequenceClassification with Wav2Vec2->SEWD, wav2vec2->sew_d, WAV2VEC2->SEWD
