...
# Copied from transformers_4571.models.bert.modeling_bert.BertSelfOutput with Bert->Bros
...
# Copied from transformers_4571.models.bert.modeling_bert.BertIntermediate with Bert->Bros
...
# Copied from transformers_4571.models.bert.modeling_bert.BertPooler with Bert->Bros
...
class BrosModel(BrosPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformers_4571 import BrosProcessor, BrosModel
...
class BrosForTokenClassification(BrosPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformers_4571 import BrosProcessor, BrosForTokenClassification
...
class BrosSpadeEEForTokenClassification(BrosPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformers_4571 import BrosProcessor, BrosSpadeEEForTokenClassification
...
class BrosSpadeELForTokenClassification(BrosPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformers_4571 import BrosProcessor, BrosSpadeELForTokenClassification
