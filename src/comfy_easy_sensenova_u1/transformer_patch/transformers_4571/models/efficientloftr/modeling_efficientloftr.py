...
# Copied from transformers_4571.models.rt_detr_v2.modeling_rt_detr_v2.RTDetrV2ConvNormLayer with RTDetrV2->EfficientLoFTR
...
# Copied from transformers_4571.models.cohere.modeling_cohere.rotate_half
def rotate_half(x):
...
# Copied from transformers_4571.models.cohere.modeling_cohere.apply_rotary_pos_emb
...
# Copied from transformers_4571.models.cohere.modeling_cohere.repeat_kv
...
class EfficientLoFTRPreTrainedModel(PreTrainedModel):
    ...
    # Copied from transformers_4571.models.superpoint.modeling_superpoint.SuperPointPreTrainedModel.extract_one_channel_pixel_values with SuperPoint->EfficientLoFTR
