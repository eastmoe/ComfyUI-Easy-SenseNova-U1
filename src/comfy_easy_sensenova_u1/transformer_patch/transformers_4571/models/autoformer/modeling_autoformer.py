...
# Copied from transformers_4571.models.time_series_transformer.modeling_time_series_transformer.TimeSeriesFeatureEmbedder with TimeSeries->Autoformer
...
# Copied from transformers_4571.models.time_series_transformer.modeling_time_series_transformer.TimeSeriesStdScaler with TimeSeriesTransformer->Autoformer,TimeSeries->Autoformer
...
# Copied from transformers_4571.models.time_series_transformer.modeling_time_series_transformer.TimeSeriesMeanScaler with TimeSeriesTransformer->Autoformer,TimeSeries->Autoformer
...
# Copied from transformers_4571.models.time_series_transformer.modeling_time_series_transformer.TimeSeriesNOPScaler with TimeSeriesTransformer->Autoformer,TimeSeries->Autoformer
...
# Copied from transformers_4571.models.time_series_transformer.modeling_time_series_transformer.weighted_average
...
# Copied from transformers_4571.models.time_series_transformer.modeling_time_series_transformer.nll
...
# Copied from transformers_4571.models.marian.modeling_marian.MarianSinusoidalPositionalEmbedding with Marian->Autoformer
...
# Copied from transformers_4571.models.time_series_transformer.modeling_time_series_transformer.TimeSeriesValueEmbedding with TimeSeries->Autoformer
...
class AutoformerPreTrainedModel(PreTrainedModel):
    ...
    # Copied from transformers_4571.models.bart.modeling_bart.BartPreTrainedModel._update_full_mask
...
# Copied from transformers_4571.models.time_series_transformer.modeling_time_series_transformer.TimeSeriesTransformerEncoder with TimeSeriesTransformer->Autoformer,TimeSeries->Autoformer
...
class AutoformerModel(AutoformerPreTrainedModel):
    ...
    def forward(
        ...
        >>> import torch
        >>> from transformers_4571 import AutoformerModel
...
class AutoformerForPrediction(AutoformerPreTrainedModel):
    ...
    def forward(
        ...
        >>> from huggingface_hub import hf_hub_download
        >>> import torch
        >>> from transformers_4571 import AutoformerForPrediction
        ...
        >>> from huggingface_hub import hf_hub_download
        >>> import torch
        >>> from transformers_4571 import AutoformerConfig, AutoformerForPrediction
