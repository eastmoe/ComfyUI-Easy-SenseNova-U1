...
class UniSpeechSatForPreTraining(UniSpeechSatPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformers_4571 import AutoFeatureExtractor, UniSpeechSatForPreTraining
        >>> from transformers_4571.models.unispeech_sat.modeling_unispeech_sat import _compute_mask_indices
