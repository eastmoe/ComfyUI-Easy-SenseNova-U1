...
# copied from transformers_4571.models.granite.modeling_granite.GraniteAttention with Granite->GraniteMoeHybrid
...
class GraniteMoeHybridForCausalLM(GraniteMoeHybridPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, GraniteMoeHybridForCausalLM
