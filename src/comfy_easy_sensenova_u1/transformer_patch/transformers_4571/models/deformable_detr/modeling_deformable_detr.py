...
# Copied from transformers_4571.models.detr.modeling_detr.DetrFrozenBatchNorm2d with Detr->DeformableDetr
...
# Copied from transformers_4571.models.detr.modeling_detr.replace_batch_norm with Detr->DeformableDetr
...
class DeformableDetrConvEncoder(nn.Module):
    ...
    # Copied from transformers_4571.models.detr.modeling_detr.DetrConvEncoder.forward with Detr->DeformableDetr
...
# Copied from transformers_4571.models.detr.modeling_detr.DetrConvModel with Detr->DeformableDetr
...
# Copied from transformers_4571.models.detr.modeling_detr.DetrLearnedPositionEmbedding
...
# Copied from transformers_4571.models.detr.modeling_detr.build_position_encoding with Detr->DeformableDetr
...
class DeformableDetrModel(DeformableDetrPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoImageProcessor, DeformableDetrModel
...
class DeformableDetrForObjectDetection(DeformableDetrPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoImageProcessor, DeformableDetrForObjectDetection
        >>> from PIL import Image
        >>> import requests
