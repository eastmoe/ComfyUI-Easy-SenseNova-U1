...
class SiglipTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import SiglipTextConfig, SiglipTextModel
...
class SiglipConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import SiglipConfig, SiglipModel
    ...
    >>> from transformers_4571 import SiglipTextConfig, SiglipVisionConfig
