...
from transformers_4571.models.superpoint.configuration_superpoint import SuperPointConfig
...
class SuperPointForKeypointDetection(SuperPointPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoImageProcessor, SuperPointForKeypointDetection
        >>> import torch
