...
class SmolVLMVisionConfig(Idefics3VisionConfig):
    ...
    ```python
    >>> from transformers_4571.models.smolvlm.modeling_smolvlm import SmolVLMVisionTransformer
    >>> from transformers_4571.models.smolvlm.configuration_smolvlm import SmolVLMVisionConfig
...
class SmolVLMConfig(Idefics3Config):
    ...
    Example:
    ```python
    >>> from transformers_4571 import SmolVLMModel, SmolVLMConfig
...
class SmolVLMForConditionalGeneration(Idefics3ForConditionalGeneration):
    ...
    def forward(self, **super_kwargs):
        ...
        >>> from transformers_4571 import AutoProcessor, AutoModelForImageTextToText
