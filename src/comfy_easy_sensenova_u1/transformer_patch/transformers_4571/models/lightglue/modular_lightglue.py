...
class LightGlueConfig(PretrainedConfig):
    ...
    Examples:
        ```python
        >>> from transformers_4571 import LightGlueConfig, LightGlueForKeypointMatching
...
class LightGlueImageProcessor(SuperGlueImageProcessor):
    ...
    # Copied from transformers_4571.models.efficientloftr.image_processing_efficientloftr.EfficientLoFTRImageProcessor.visualize_keypoint_matching with EfficientLoFTR->LightGlue
