...
class DetrImageProcessorFast(BaseImageProcessorFast):
    ...
    # Copied from transformers_4571.models.detr.image_processing_detr.DetrImageProcessor.post_process
    ...
    # Copied from transformers_4571.models.detr.image_processing_detr.DetrImageProcessor.post_process_segmentation
    ...
    # Copied from transformers_4571.models.detr.image_processing_detr.DetrImageProcessor.post_process_instance
    ...
    # Copied from transformers_4571.models.detr.image_processing_detr.DetrImageProcessor.post_process_panoptic
    ...
    # Copied from transformers_4571.models.detr.image_processing_detr.DetrImageProcessor.post_process_object_detection
    ...
    # Copied from transformers_4571.models.detr.image_processing_detr.DetrImageProcessor.post_process_semantic_segmentation
    ...
    # Copied from transformers_4571.models.detr.image_processing_detr.DetrImageProcessor.post_process_instance_segmentation
    ...
    # Copied from transformers_4571.models.detr.image_processing_detr.DetrImageProcessor.post_process_panoptic_segmentation
