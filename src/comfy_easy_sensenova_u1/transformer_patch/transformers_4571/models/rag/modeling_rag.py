...
class RagPreTrainedModel(PreTrainedModel):
    ...
    def from_pretrained_question_encoder_generator(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_4571 import RagModel
...
class RagModel(RagPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, RagRetriever, RagModel
        >>> import torch
...
class RagSequenceForGeneration(RagPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,  # needs kwargs for generation
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, RagRetriever, RagSequenceForGeneration
        >>> import torch
...
class RagTokenForGeneration(RagPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs,  # needs kwargs for generation
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, RagRetriever, RagTokenForGeneration
        >>> import torch
