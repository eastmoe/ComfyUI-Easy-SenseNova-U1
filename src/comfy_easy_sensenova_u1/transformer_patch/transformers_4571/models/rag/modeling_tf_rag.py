...
class TFRagPreTrainedModel(TFPreTrainedModel):
    ...
    def from_pretrained_question_encoder_generator(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_4571 import RagRetriever, TFRagModel
    ...
    def call(
        ...
        **kwargs,
        ...
        r"""
                        ...
                        ```python
                        >>> from transformers_4571 import AutoTokenizer, RagRetriever, TFRagModel
                        >>> import torch
...
class TFRagTokenForGeneration(TFRagPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def call(
        ...
        **kwargs,  # needs kwargs for generation
        ...
        ```python
        >>> import tensorflow as tf
        >>> from transformers_4571 import AutoTokenizer, RagRetriever, TFRagTokenForGeneration
...
class TFRagSequenceForGeneration(TFRagPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def call(
        ...
        **kwargs,  # needs kwargs for generation
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, RagRetriever, TFRagSequenceForGeneration
