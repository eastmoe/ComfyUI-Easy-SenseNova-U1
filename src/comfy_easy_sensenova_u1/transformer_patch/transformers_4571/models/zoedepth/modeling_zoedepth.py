...
class ZoeDepthReassembleLayer(nn.Module):
    ...
    # Copied from transformers_4571.models.dpt.modeling_dpt.DPTReassembleLayer.forward with DPT->ZoeDepth
...
# Copied from transformers_4571.models.dpt.modeling_dpt.DPTFeatureFusionStage with DPT->ZoeDepth
...
# Copied from transformers_4571.models.dpt.modeling_dpt.DPTPreActResidualLayer with DPT->ZoeDepth
...
# Copied from transformers_4571.models.dpt.modeling_dpt.DPTFeatureFusionLayer with DPT->ZoeDepth
...
class ZoeDepthNeck(nn.Module):
    ...
    * ZoeDepthFeatureFusionStage.
    ...
    # Copied from transformers_4571.models.dpt.modeling_dpt.DPTNeck.__init__ with DPT->ZoeDepth
    def __init__(self, config: ZoeDepthConfig):
        super().__init__()
        self.config = config
...
# Copied from transformers_4571.models.grounding_dino.modeling_grounding_dino.GroundingDinoMultiheadAttention with GroundingDino->ZoeDepth
...
# Modified from transformers_4571.models.dpt.modeling_dpt.DPTPreTrainedModel with DPT->ZoeDepth,dpt->zoedepth
...
class ZoeDepthForDepthEstimation(ZoeDepthPreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from transformers_4571 import AutoImageProcessor, ZoeDepthForDepthEstimation
        >>> import torch
        >>> import numpy as np
