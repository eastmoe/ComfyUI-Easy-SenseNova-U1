...
# Copied from transformers_4571.models.bart.modeling_tf_bart.TFBartAttention with Bart->XGLM
...
class TFXGLMDecoderLayer(keras.layers.Layer):
    ...
    # Copied from transformers_4571.models.mbart.modeling_tf_mbart.TFMBartDecoderLayer.call
    def call(
        self,
        hidden_states: tf.Tensor,
        attention_mask: tf.Tensor | None = None,
