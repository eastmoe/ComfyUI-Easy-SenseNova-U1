...
from transformers_4571.utils.import_utils import is_mistral_common_available
...
def tokenizer_class_from_name(class_name: str) -> Union[type[Any], None]:
    ...
    for module_name, tokenizers in TOKENIZER_MAPPING_NAMES.items():
        if class_name in tokenizers:
            ...
            if module_name in ["mistral", "mixtral", "ministral"] and class_name == "MistralCommonTokenizer":
                module = importlib.import_module(".tokenization_mistral_common", "transformers_4571")
            else:
                module = importlib.import_module(f".{module_name}", "transformers_4571.models")
            try:
    ...
    main_module = importlib.import_module("transformers_4571")
...
def get_tokenizer_config(
    ...
    **kwargs,
    ...
    from transformers_4571 import AutoTokenizer
