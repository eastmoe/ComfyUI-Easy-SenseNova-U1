...
class Gemma3nTextConfig(Gemma2Config, PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import Gemma3nTextModel, Gemma3nTextConfig
...
class Gemma3nAudioConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import Gemma3nAudioConfig, Gemma3nAudioEncoder
...
class Gemma3nVisionConfig(TimmWrapperConfig):
    ...
    Example:
    ```python
    >>> from transformers_4571 import Gemma3nVisionConfig, TimmWrapper
...
class Gemma3nConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import Gemma3nForConditionalGeneration, Gemma3nConfig, Gemma3nTextConfig
...
class Gemma3nModel(PaliGemmaModel):
    ...
    def forward(
        ...
        **lm_kwargs,
        ...
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, Gemma3nForConditionalGeneration
...
class Gemma3nForConditionalGeneration(PaliGemmaForConditionalGeneration):
    ...
    def forward(
        ...
        **lm_kwargs,
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, Gemma3ForConditionalGeneration
