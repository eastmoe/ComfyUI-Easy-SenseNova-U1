...
from transformers_4571.models.jamba.modeling_jamba import HybridMambaAttentionDynamicCache, JambaAttentionDecoderLayer
from transformers_4571.models.llama.modeling_llama import (
    LlamaAttention,
    LlamaForCausalLM,
    LlamaMLP,
    LlamaRMSNorm,
...
from transformers_4571.models.mamba2.modeling_mamba2 import (
    MambaRMSNormGated,
    pad_tensor_by_size,
    reshape_into_chunks,
    segment_sum,
...
# Adapted from transformers_4571.models.jamba.modeling_jamba.HybridMambaAttentionDynamicCache for the v2 mixer
...
# Adapted from transformers_4571.models.glm.modular_glm.apply_rotary_pos_emb
...
# Adapted from transformers_4571.models.mamba2.modeling_mamba2.Mamba2Mixer
...
class BambaForCausalLM(LlamaForCausalLM):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, BambaForCausalLM
