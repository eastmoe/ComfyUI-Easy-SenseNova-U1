...
class OneFormerImageProcessor(BaseImageProcessor):
    ...
    # Copied from transformers_4571.models.vilt.image_processing_vilt.ViltImageProcessor.pad
    def pad(
        self,
    ...
    # Copied from transformers_4571.models.maskformer.image_processing_maskformer.MaskFormerImageProcessor.post_process_semantic_segmentation
    ...
    # Copied from transformers_4571.models.maskformer.image_processing_maskformer.MaskFormerImageProcessor.post_process_panoptic_segmentation
