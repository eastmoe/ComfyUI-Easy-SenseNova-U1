...
# Copied from transformers_4571.models.pix2struct.image_processing_pix2struct.torch_extract_patches
...
class Kosmos2_5ImageProcessor(BaseImageProcessor):
    ...
    # Copied from transformers_4571.models.pix2struct.image_processing_pix2struct.Pix2StructImageProcessor.normalize
    def normalize(
        self,
        image: np.ndarray,
