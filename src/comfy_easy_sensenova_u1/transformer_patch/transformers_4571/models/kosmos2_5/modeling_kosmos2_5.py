...
# Copied from transformers_4571.models.kosmos2.modeling_kosmos2._expand_mask
...
# Copied from transformers_4571.models.pix2struct.modeling_pix2struct.Pix2StructLayerNorm with Pix2Struct->Kosmos2_5
...
# Copied from transformers_4571.models.t5.modeling_t5.T5DenseGatedActDense with T5DenseGatedActDense->Pix2StructVisionMlp,T5Config->Pix2StructVisionConfig,config.d_model->config.hidden_size,dropout_rate->dropout_rate
...
# Adapted from transformers_4571.models.pix2struct.modeling_pix2struct.Pix2StructVisionEncoder with Pix2Struct->Kosmos2_5
...
# Copied from transformers_4571.models.kosmos2.modeling_kosmos2.Kosmos2TextSinusoidalPositionalEmbedding with Kosmos2->Kosmos2_5
class Kosmos2_5TextSinusoidalPositionalEmbedding(nn.Module):
    """This module produces sinusoidal positional embeddings of any length."""

    # Copied from transformers_4571.models.m2m_100.modeling_m2m_100.M2M100SinusoidalPositionalEmbedding.__init__
    ...
    # Copied from transformers_4571.models.m2m_100.modeling_m2m_100.M2M100SinusoidalPositionalEmbedding.make_weights
    ...
    @staticmethod
    # Copied from transformers_4571.models.m2m_100.modeling_m2m_100.M2M100SinusoidalPositionalEmbedding.get_embedding
    ...
    # Copied from transformers_4571.models.m2m_100.modeling_m2m_100.M2M100SinusoidalPositionalEmbedding.create_position_ids_from_inputs_embeds
...
# Copied from transformers_4571.models.kosmos2.modeling_kosmos2.Kosmos2TextFFN with Kosmos2->Kosmos2_5
...
class Kosmos2_5TextBlock(GradientCheckpointingLayer):
    ...
    # Adapted from transformers_4571.models.kosmos2.modeling_kosmos2.Kosmos2TextBlock.forward
    def forward(
        self,
        hidden_states: torch.Tensor,
        attention_mask: Optional[torch.Tensor] = None,
...
# Adapted from transformers_4571.models.kosmos2.modeling_kosmos2.Kosmos2TextTransformer with Kosmos2->Kosmos2_5
...
class Kosmos2_5VisionModel(Kosmos2_5PreTrainedModel):
    ...
    # Copied from transformers_4571.models.pix2struct.modeling_pix2struct.Pix2StructVisionModel.__init__ with Pix2Struct->Kosmos2_5
    def __init__(self, config: Kosmos2_5VisionConfig):
    ...
    # Copied from transformers_4571.models.pix2struct.modeling_pix2struct.Pix2StructVisionModel.get_input_embeddings
    def get_input_embeddings(self):
        return self.embeddings.patch_projection

    # Copied from transformers_4571.models.pix2struct.modeling_pix2struct.Pix2StructVisionModel._prune_heads
...
# Adapted from transformers_4571.models.kosmos2.modeling_kosmos2.Kosmos2TextModel with KOSMOS2->KOSMOS2_5
...
class Kosmos2_5Model(Kosmos2_5PreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, Kosmos2_5Model
...
class Kosmos2_5ForConditionalGeneration(Kosmos2_5PreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> import requests
        >>> import torch
        >>> from transformers_4571 import AutoProcessor, Kosmos2_5ForConditionalGeneration
