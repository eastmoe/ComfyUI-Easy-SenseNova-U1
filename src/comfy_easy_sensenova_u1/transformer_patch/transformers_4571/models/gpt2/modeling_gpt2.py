...
# Copied from transformers_4571.models.xlm.modeling_xlm.XLMSequenceSummary with XLM->GPT2
...
class GPT2DoubleHeadsModel(GPT2PreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> import torch
        >>> from transformers_4571 import AutoTokenizer, GPT2DoubleHeadsModel
