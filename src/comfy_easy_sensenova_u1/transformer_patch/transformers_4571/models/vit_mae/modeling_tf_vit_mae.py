...
# Copied from transformers_4571.models.vit.modeling_tf_vit.TFViTSelfAttention with ViT->ViTMAE
...
# Copied from transformers_4571.models.vit.modeling_tf_vit.TFViTSelfOutput with ViT->ViTMAE
...
# Copied from transformers_4571.models.vit.modeling_tf_vit.TFViTAttention with ViT->ViTMAE
...
# Copied from transformers_4571.models.vit.modeling_tf_vit.TFViTIntermediate with ViT->ViTMAE
...
# Copied from transformers_4571.models.vit.modeling_tf_vit.TFViTOutput with ViT->ViTMAE
...
# Copied from transformers_4571.models.vit.modeling_tf_vit.TFViTLayer with ViT->ViTMAE
...
# Copied from transformers_4571.models.vit.modeling_tf_vit.TFViTEncoder with ViT->ViTMAE
...
class TFViTMAEModel(TFViTMAEPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from transformers_4571 import AutoImageProcessor, TFViTMAEModel
...
class TFViTMAEForPreTraining(TFViTMAEPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from transformers_4571 import AutoImageProcessor, TFViTMAEForPreTraining
        >>> from PIL import Image
        >>> import requests
