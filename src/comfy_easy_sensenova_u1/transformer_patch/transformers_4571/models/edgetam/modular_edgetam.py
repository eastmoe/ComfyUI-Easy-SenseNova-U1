...
from transformers_4571.models.sam2.configuration_sam2 import Sam2Config, Sam2MaskDecoderConfig, Sam2PromptEncoderConfig
from transformers_4571.models.sam2.modeling_sam2 import (
    Sam2Attention,
    Sam2FeedForward,
    Sam2LayerNorm,
    Sam2Model,
...
from transformers_4571.utils.generic import TransformersKwargs, check_model_inputs
...
# fix this in modular
if True:
    from transformers_4571.models.timm_wrapper.modeling_timm_wrapper import TimmWrapperModel
