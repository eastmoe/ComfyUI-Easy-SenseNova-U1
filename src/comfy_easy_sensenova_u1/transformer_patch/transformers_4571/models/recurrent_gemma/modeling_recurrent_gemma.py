...
# Copied from transformers_4571.models.gemma.modeling_gemma.GemmaRMSNorm with Gemma->RecurrentGemma
...
# TODO: re-enable check: Copied from transformers_4571.models.llama.modeling_llama.LlamaForCausalLM with LLAMA->RECURRENTGEMMA,Llama->RecurrentGemma,llama->gemma
@auto_docstring
class RecurrentGemmaForCausalLM(RecurrentGemmaPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, RecurrentGemmaForCausalLM
