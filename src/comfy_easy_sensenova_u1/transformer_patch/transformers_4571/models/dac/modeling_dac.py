...
@dataclass
@auto_docstring
# Copied from transformers_4571.models.encodec.modeling_encodec.EncodecDecoderOutput with Encodec->Dac, segment_length->input_length
...
class DacModel(DacPreTrainedModel):
    ...
    def forward(
        ...
        >>> from transformers_4571 import DacModel, AutoProcessor
