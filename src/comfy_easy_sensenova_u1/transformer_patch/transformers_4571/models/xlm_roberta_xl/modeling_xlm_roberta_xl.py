...
# Copied from transformers_4571.models.bert.modeling_bert.BertSelfAttention with Bert->XLMRobertaXL
...
# Copied from transformers_4571.models.bert.modeling_bert.BertSdpaSelfAttention with Bert->XLMRobertaXL
...
class XLMRobertaXLPreTrainedModel(PreTrainedModel):
    ...
    # Copied from transformers_4571.models.bert.modeling_bert.BertPreTrainedModel._init_weights with BertLMPredictionHead->XLMRobertaXLLMHead
...
@auto_docstring
# Copied from transformers_4571.models.bert.modeling_bert.BertModel with Bert->XLMRobertaXL, BERT->XLM_ROBERTA_XL
...
class XLMRobertaXLForCausalLM(XLMRobertaXLPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, RobertaForCausalLM, RobertaConfig
        >>> import torch
