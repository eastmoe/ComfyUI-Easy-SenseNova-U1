...
class XLMRobertaXLConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import XLMRobertaXLConfig, XLMRobertaXLModel
...
# Copied from transformers_4571.models.roberta.configuration_roberta.RobertaOnnxConfig with Roberta->XLMRobertaXL
