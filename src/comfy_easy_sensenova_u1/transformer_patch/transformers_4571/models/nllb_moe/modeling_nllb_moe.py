...
# Copied from transformers_4571.models.m2m_100.modeling_m2m_100.M2M100ScaledWordEmbedding with M2M100->NllbMoe
...
# Copied from transformers_4571.models.musicgen.modeling_musicgen.MusicgenAttention with Musicgen->NllbMoe,key_value_states->encoder_hidden_states
...
class NllbMoeModel(NllbMoePreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, NllbMoeModel
...
class NllbMoeForConditionalGeneration(NllbMoePreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, NllbMoeForConditionalGeneration
