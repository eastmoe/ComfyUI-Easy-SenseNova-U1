...
# Copied from transformers_4571.models.vit.modeling_tf_vit.TFViTSelfAttention with ViT->DeiT
...
# Copied from transformers_4571.models.vit.modeling_tf_vit.TFViTSelfOutput with ViT->DeiT
...
# Copied from transformers_4571.models.vit.modeling_tf_vit.TFViTAttention with ViT->DeiT
...
# Copied from transformers_4571.models.vit.modeling_tf_vit.TFViTIntermediate with ViT->DeiT
...
# Copied from transformers_4571.models.vit.modeling_tf_vit.TFViTOutput with ViT->DeiT
...
# Copied from transformers_4571.models.vit.modeling_tf_vit.TFViTEncoder with ViT->DeiT
...
# Copied from transformers_4571.models.vit.modeling_tf_vit.TFViTPreTrainedModel with ViT->DeiT all-casing
...
# Copied from transformers_4571.models.vit.modeling_tf_vit.TFViTPooler with ViT->DeiT
...
class TFDeiTForMaskedImageModeling(TFDeiTPreTrainedModel):
    ...
    def call(
        ...
        Examples:
        ```python
        >>> from transformers_4571 import AutoImageProcessor, TFDeiTForMaskedImageModeling
        >>> import tensorflow as tf
...
class TFDeiTForImageClassification(TFDeiTPreTrainedModel, TFSequenceClassificationLoss):
    ...
    def call(
        ...
        ```python
        >>> from transformers_4571 import AutoImageProcessor, TFDeiTForImageClassification
        >>> import tensorflow as tf
        >>> from PIL import Image
        >>> import requests
