...
class DepthProModel(DepthProPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, DepthProModel
...
# Copied from transformers_4571.models.dpt.modeling_dpt.DPTPreActResidualLayer DPT->DepthPro
...
# Modified from transformers_4571.models.dpt.modeling_dpt.DPTFeatureFusionLayer
...
# Modified from transformers_4571.models.dpt.modeling_dpt.DPTFeatureFusionStage with DPT->DepthPro
...
class DepthProForDepthEstimation(DepthProPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoImageProcessor, DepthProForDepthEstimation
        >>> import torch
        >>> from PIL import Image
        >>> import requests
