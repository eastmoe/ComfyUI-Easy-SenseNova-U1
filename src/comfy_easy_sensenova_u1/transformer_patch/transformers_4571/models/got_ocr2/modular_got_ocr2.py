...
class GotOcr2Config(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import GotOcr2ForConditionalGeneration, GotOcr2Config
...
class GotOcr2ForConditionalGeneration(LlavaForConditionalGeneration):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, GotOcr2ForConditionalGeneration, TextStreamer
