...
class SqueezeBertConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import SqueezeBertConfig, SqueezeBertModel
...
# # Copied from transformers_4571.models.bert.configuration_bert.BertOnxxConfig with Bert->SqueezeBert
