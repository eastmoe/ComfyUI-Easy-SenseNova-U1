...
class MobileNetV2ImageProcessorFast(BaseImageProcessorFast):
    ...
    # Copied from transformers_4571.models.beit.image_processing_beit_fast.BeitImageProcessorFast.reduce_label
    ...
    # Copied from transformers_4571.models.beit.image_processing_beit_fast.BeitImageProcessorFast.post_process_semantic_segmentation with Beit->MobileNetV2
