...
from transformers_4571.models.blip.image_processing_blip import BlipImageProcessor
...
class JanusConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import JanusForConditionalGeneration, JanusConfig, JanusVisionConfig, JanusVQVAEConfig, LlamaConfig
