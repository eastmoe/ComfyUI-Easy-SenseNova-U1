...
class TFT5Model(TFT5PreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, TFT5Model
...
class TFT5ForConditionalGeneration(TFT5PreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def call(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, TFT5ForConditionalGeneration
...
class TFT5EncoderModel(TFT5PreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, TFT5EncoderModel
