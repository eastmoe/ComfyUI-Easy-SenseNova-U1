...
class T5Model(T5PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, T5Model
...
class T5ForConditionalGeneration(T5PreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, T5ForConditionalGeneration
...
class T5EncoderModel(T5PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, T5EncoderModel
