...
class XLMRobertaConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import XLMRobertaConfig, XLMRobertaModel
...
# Copied from transformers_4571.models.roberta.configuration_roberta.RobertaOnnxConfig with Roberta->XLMRoberta
