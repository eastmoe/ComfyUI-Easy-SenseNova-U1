...
class Glm4vVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import Glm4vVisionConfig, Glm4vVisionModel
...
class Glm4vTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import Glm4vTextModel, Glm4vConfig
...
class Glm4vConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import Glm4vForConditionalGeneration, Glm4vConfig
...
class Glm4vForConditionalGeneration(Qwen2_5_VLForConditionalGeneration):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, Glm4vForConditionalGeneration
