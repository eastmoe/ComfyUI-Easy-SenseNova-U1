...
class DepthAnythingReassembleLayer(nn.Module):
    ...
    # Copied from transformers_4571.models.dpt.modeling_dpt.DPTReassembleLayer.forward
...
class DepthAnythingFeatureFusionStage(nn.Module):
    # Copied from transformers_4571.models.dpt.modeling_dpt.DPTFeatureFusionStage.__init__ with DPT->DepthAnything
...
# Modified from transformers_4571.models.dpt.modeling_dpt.DPTPreTrainedModel with DPT->DepthAnything,dpt->depth_anything
...
class DepthAnythingForDepthEstimation(DepthAnythingPreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from transformers_4571 import AutoImageProcessor, AutoModelForDepthEstimation
        >>> import torch
        >>> import numpy as np
