...
# Copied from transformers_4571.models.clip.modeling_clip.clip_loss with clip->blip
...
# Copied from transformers_4571.models.clip.modeling_clip.CLIPTextEmbeddings with CLIP->Blip
...
# Copied from transformers_4571.models.clip.modeling_clip.CLIPMLP with CLIP->Blip
...
class BlipModel(BlipPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from transformers_4571 import AutoProcessor, BlipModel
...
class BlipForConditionalGeneration(BlipPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, BlipForConditionalGeneration
...
class BlipForQuestionAnswering(BlipPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, BlipForQuestionAnswering
...
class BlipForImageTextRetrieval(BlipPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, BlipForImageTextRetrieval
