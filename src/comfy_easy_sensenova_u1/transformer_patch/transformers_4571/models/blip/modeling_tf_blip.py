...
# Copied from transformers_4571.models.clip.modeling_tf_clip.contrastive_loss
...
# Copied from transformers_4571.models.clip.modeling_tf_clip.clip_loss with clip->blip
...
# Copied from transformers_4571.models.clip.modeling_tf_clip.TFCLIPTextEmbeddings with CLIP->Blip
...
class TFBlipModel(TFBlipPreTrainedModel):
    ...
    def call(
        ...
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, TFBlipModel
...
class TFBlipForConditionalGeneration(TFBlipPreTrainedModel):
    ...
    def call(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, TFBlipForConditionalGeneration
...
class TFBlipForQuestionAnswering(TFBlipPreTrainedModel):
    ...
    # Adapted from transformers_4571.models.t5.modeling_tf_t5.TFT5PreTrainedModel._shift_right
    ...
    def call(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, TFBlipForQuestionAnswering
...
class TFBlipForImageTextRetrieval(TFBlipPreTrainedModel):
    ...
    def call(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, TFBlipForImageTextRetrieval
