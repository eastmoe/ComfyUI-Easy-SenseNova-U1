...
class BlipTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import BlipTextConfig, BlipTextModel
...
class BlipVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import BlipVisionConfig, BlipVisionModel
...
class BlipConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import BlipConfig, BlipModel
