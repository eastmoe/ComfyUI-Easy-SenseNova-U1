...
# Copied from transformers_4571.models.vit.modeling_vit.ViTPatchEmbeddings with ViT->ViTMSN
...
# Copied from transformers_4571.models.vit.modeling_vit.ViTSelfAttention with ViT->ViTMSN
...
# Copied from transformers_4571.models.vit.modeling_vit.ViTSelfOutput with ViT->ViTMSN
...
# Copied from transformers_4571.models.vit.modeling_vit.ViTAttention with ViT->ViTMSN
...
# Copied from transformers_4571.models.vit.modeling_vit.ViTIntermediate with ViT->ViTMSN
...
# Copied from transformers_4571.models.vit.modeling_vit.ViTOutput with ViT->ViTMSN
...
# Copied from transformers_4571.models.vit.modeling_vit.ViTLayer with ViT->ViTMSN, VIT->VITMSN
...
# Copied from transformers_4571.models.vit.modeling_vit.ViTEncoder with ViT->ViTMSN
...
class ViTMSNModel(ViTMSNPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        ```python
        >>> from transformers_4571 import AutoImageProcessor, ViTMSNModel
        >>> import torch
...
class ViTMSNForImageClassification(ViTMSNPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        ```python
        >>> from transformers_4571 import AutoImageProcessor, ViTMSNForImageClassification
        >>> import torch
        >>> from PIL import Image
        >>> import requests
