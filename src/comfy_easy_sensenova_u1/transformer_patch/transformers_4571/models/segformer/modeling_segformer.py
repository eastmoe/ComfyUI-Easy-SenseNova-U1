...
# Copied from transformers_4571.models.convnext.modeling_convnext.ConvNextDropPath with ConvNext->Segformer
...
class SegformerForSemanticSegmentation(SegformerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoImageProcessor, SegformerForSemanticSegmentation
