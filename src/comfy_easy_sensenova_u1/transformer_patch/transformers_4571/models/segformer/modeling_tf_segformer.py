...
# Copied from transformers_4571.models.convnext.modeling_tf_convnext.TFConvNextDropPath with ConvNext->Segformer
...
class TFSegformerForSemanticSegmentation(TFSegformerPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from transformers_4571 import AutoImageProcessor, TFSegformerForSemanticSegmentation
