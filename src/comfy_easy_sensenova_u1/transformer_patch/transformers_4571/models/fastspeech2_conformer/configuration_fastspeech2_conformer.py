...
class FastSpeech2ConformerConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import FastSpeech2ConformerModel, FastSpeech2ConformerConfig
...
class FastSpeech2ConformerHifiGanConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import FastSpeech2ConformerHifiGan, FastSpeech2ConformerHifiGanConfig
