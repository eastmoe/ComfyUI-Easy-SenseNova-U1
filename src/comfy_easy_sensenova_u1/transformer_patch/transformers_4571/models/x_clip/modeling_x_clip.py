...
# Copied from transformers_4571.models.clip.modeling_clip.clip_loss with clip->x_clip
...
# Copied from transformers_4571.models.clip.modeling_clip.CLIPVisionEmbeddings with CLIP->XCLIP
...
# Copied from transformers_4571.models.clip.modeling_clip.CLIPTextEmbeddings with CLIP->XCLIP
...
# Copied from transformers_4571.models.altclip.modeling_altclip.AltCLIPEncoderLayer with AltCLIP->XCLIP
...
# Copied from transformers_4571.models.beit.modeling_beit.BeitDropPath with Beit->XCLIP
...
# Copied from transformers_4571.models.altclip.modeling_altclip.AltCLIPEncoder with AltCLIP->XCLIP
...
class XCLIPTextModel(XCLIPPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, XCLIPTextModel
...
class XCLIPVisionModel(XCLIPPreTrainedModel):
    ...
    def forward(
        ...
        >>> from transformers_4571 import AutoProcessor, XCLIPVisionModel
