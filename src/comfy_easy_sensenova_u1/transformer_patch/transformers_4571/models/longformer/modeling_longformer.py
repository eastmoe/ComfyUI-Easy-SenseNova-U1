...
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaLMHead with Roberta->Longformer
...
class LongformerModel(LongformerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformers_4571 import LongformerModel, AutoTokenizer
...
class LongformerForMaskedLM(LongformerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, LongformerForMaskedLM
...
class LongformerForQuestionAnswering(LongformerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, LongformerForQuestionAnswering
        >>> import torch
