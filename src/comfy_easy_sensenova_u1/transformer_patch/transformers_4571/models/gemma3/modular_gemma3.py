...
class Gemma3TextConfig(Gemma2Config, PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import Gemma3TextModel, Gemma3TextConfig
...
class Gemma3Config(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import Gemma3ForConditionalGeneration, Gemma3Config, SiglipVisionConfig, Gemma3TextConfig
