...
# Copied from transformers_4571.models.clip.modeling_clip.clip_loss with clip->groupvit
...
# Copied from transformers_4571.models.clip.modeling_clip.CLIPTextEmbeddings with CLIP->GroupViT
...
# Copied from transformers_4571.models.altclip.modeling_altclip.AltCLIPEncoderLayer with AltCLIP->GroupViT
...
class GroupViTTextModel(GroupViTPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import CLIPTokenizer, GroupViTTextModel
...
class GroupViTVisionModel(GroupViTPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, GroupViTVisionModel
...
class GroupViTModel(GroupViTPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> import torch
        >>> from transformers_4571 import CLIPTokenizer, GroupViTModel
    ...
    def get_image_features(self, pixel_values: torch.Tensor) -> torch.FloatTensor:
        ...
        ```python
        >>> import torch
        >>> from transformers_4571 import AutoProcessor, GroupViTModel
