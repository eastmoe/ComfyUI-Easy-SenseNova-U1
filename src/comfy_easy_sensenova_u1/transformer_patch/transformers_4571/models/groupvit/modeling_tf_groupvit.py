...
# Copied from transformers_4571.models.clip.modeling_tf_clip.clip_loss with clip->groupvit
...
# Adapted from transformers_4571.models.vit.modeling_tf_vit.TFViTPatchEmbeddings with ViT->GroupViT
...
# Adapted from transformers_4571.vit.modeling_tf_vit.TFViTEmbeddings
...
# Copied from transformers_4571.models.clip.modeling_tf_clip.TFCLIPTextEmbeddings with CLIP->GroupViT
...
# Adapted from transformers_4571.models.clip.modeling_tf_clip.TFCLIPAttention
class TFGroupViTAttention(keras.layers.Layer):
    ...
    # Copied from transformers_4571.models.bert.modeling_tf_bert.TFBertSelfAttention.transpose_for_scores
...
# Copied from transformers_4571.models.clip.modeling_tf_clip.TFCLIPEncoderLayer with CLIP->GroupViT
...
# Adapted from transformers_4571.models.clip.modeling_tf_clip.TFGroupViTTextEncoder
...
# Copied from transformers_4571.models.clip.modeling_tf_clip.TFCLIPTextTransformer with CLIPText->GroupViTText, CLIPEncoder->GroupViTTextEncoder
...
# Adapted from transformers_4571.models.clip.modeling_tf_clip.TFCLIPVisionTransformer
...
@keras_serializable
# Copied from transformers_4571.models.clip.modeling_tf_clip.TFCLIPTextMainLayer with CLIP->GroupViT
...
@keras_serializable
# Copied from transformers_4571.models.clip.modeling_tf_clip.TFCLIPVisionMainLayer with CLIP->GroupViT
...
@keras_serializable
# Adapted from transformers_4571.models.clip.modeling_tf_clip.TFCLIPMainLayer
...
class TFGroupViTTextModel(TFGroupViTPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from transformers_4571 import CLIPTokenizer, TFGroupViTTextModel
...
class TFGroupViTVisionModel(TFGroupViTPreTrainedModel):
    ...
    def call(
        ...
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, TFGroupViTVisionModel
...
class TFGroupViTModel(TFGroupViTPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from transformers_4571 import CLIPTokenizer, TFGroupViTModel
    ...
    def get_image_features(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, TFGroupViTModel
