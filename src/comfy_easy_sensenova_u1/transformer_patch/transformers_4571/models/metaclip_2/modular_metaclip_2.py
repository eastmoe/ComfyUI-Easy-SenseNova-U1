...
class MetaClip2TextConfig(CLIPTextConfig):
    ...
    ```python
    >>> from transformers_4571 import MetaClip2TextConfig, MetaClip2TextModel
...
class MetaClip2VisionConfig(CLIPVisionConfig):
    ...
    ```python
    >>> from transformers_4571 import MetaClip2VisionConfig, MetaClip2VisionModel
...
class MetaClip2Config(CLIPConfig):
    ...
    ```python
    >>> from transformers_4571 import MetaClip2Config, MetaClip2Model
    ...
    >>> from transformers_4571 import MetaClip2TextConfig, MetaClip2VisionConfig
...
class MetaClip2TextModel(CLIPTextModel):
    ...
    ```python
    >>> from transformers_4571 import AutoTokenizer, MetaClip2TextModel
...
class MetaClip2TextModelWithProjection(CLIPTextModelWithProjection):
    ...
    ```python
    >>> from transformers_4571 import AutoTokenizer, MetaClip2TextModelWithProjection
...
class MetaClip2Model(CLIPModel):
    ...
    >>> import requests
    >>> from transformers_4571 import AutoProcessor, MetaClip2Model
    ...
    def get_text_features(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, MetaClip2Model
...
class MetaClip2VisionModel(CLIPVisionModel):
    ...
    >>> from PIL import Image
    >>> import requests
    >>> from transformers_4571 import AutoProcessor, MetaClip2VisionModel
...
class MetaClip2VisionModelWithProjection(CLIPVisionModelWithProjection):
    ...
    >>> from PIL import Image
    >>> import requests
    >>> from transformers_4571 import AutoProcessor, MetaClip2VisionModelWithProjection
