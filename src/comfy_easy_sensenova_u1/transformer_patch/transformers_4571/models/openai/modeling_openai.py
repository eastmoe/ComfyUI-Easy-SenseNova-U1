...
# Copied from transformers_4571.models.xlm.modeling_xlm.XLMSequenceSummary with XLM->OpenAIGPT
...
class OpenAIGPTDoubleHeadsModel(OpenAIGPTPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, OpenAIGPTDoubleHeadsModel
        >>> import torch
