...
from transformers_4571 import PreTrainedModel
from transformers_4571.activations import ACT2CLS
...
from transformers_4571.models.textnet.configuration_textnet import TextNetConfig
from transformers_4571.utils import logging
from transformers_4571.utils.backbone_utils import BackboneMixin
...
class TextNetForImageClassification(TextNetPreTrainedModel):
    ...
    def forward(
        ...
        >>> import torch
        >>> import requests
        >>> from transformers_4571 import TextNetForImageClassification, TextNetImageProcessor
