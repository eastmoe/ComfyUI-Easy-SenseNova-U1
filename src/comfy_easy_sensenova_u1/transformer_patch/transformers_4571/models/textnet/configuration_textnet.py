...
from transformers_4571 import PretrainedConfig
from transformers_4571.utils import logging
from transformers_4571.utils.backbone_utils import BackboneConfigMixin, get_aligned_output_features_output_indices
...
class TextNetConfig(BackboneConfigMixin, PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import TextNetConfig, TextNetBackbone
