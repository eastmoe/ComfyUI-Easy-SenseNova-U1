...
class LiltLayer(GradientCheckpointingLayer):
    ...
    # Copied from transformers_4571.models.bert.modeling_bert.BertLayer.feed_forward_chunk
...
class LiltEncoder(nn.Module):
    # Copied from transformers_4571.models.bert.modeling_bert.BertEncoder.__init__ with Bert->Lilt
    def __init__(self, config, layer_idx=None):
        super().__init__()
        self.config = config
...
class LiltModel(LiltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, AutoModel
...
class LiltForSequenceClassification(LiltPreTrainedModel):
    # Copied from transformers_4571.models.roberta.modeling_roberta.RobertaForSequenceClassification.__init__ with Roberta->Lilt, roberta->lilt
    def __init__(self, config):
        super().__init__(config)
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, AutoModelForSequenceClassification
        >>> from datasets import load_dataset
...
class LiltForTokenClassification(LiltPreTrainedModel):
    # Copied from transformers_4571.models.roberta.modeling_roberta.RobertaForTokenClassification.__init__ with Roberta->Lilt, roberta->lilt
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, AutoModelForTokenClassification
        >>> from datasets import load_dataset
...
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaClassificationHead with Roberta->Lilt
...
class LiltForQuestionAnswering(LiltPreTrainedModel):
    # Copied from transformers_4571.models.roberta.modeling_roberta.RobertaForQuestionAnswering.__init__ with Roberta->Lilt, roberta->lilt
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, AutoModelForQuestionAnswering
        >>> from datasets import load_dataset
