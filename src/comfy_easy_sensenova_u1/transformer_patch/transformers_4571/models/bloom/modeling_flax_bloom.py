...
class FlaxBloomAttention(nn.Module):
    ...
    @nn.compact
    # Copied from transformers_4571.models.gptj.modeling_flax_gptj.FlaxGPTJAttention._concatenate_to_cache
...
# Copied from transformers_4571.models.gpt_neo.modeling_flax_gpt_neo.FlaxGPTNeoModel with GPTNeo->Bloom
