...
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaEmbeddings with Roberta->Camembert
...
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaSelfAttention with Roberta->Camembert
...
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaSdpaSelfAttention with Roberta->Camembert
...
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaSelfOutput with Roberta->Camembert
...
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaAttention with Roberta->Camembert,ROBERTA->CAMEMBERT
...
# Copied from transformers_4571.models.bert.modeling_bert.BertIntermediate with Bert->Roberta->Camembert
...
# Copied from transformers_4571.models.bert.modeling_bert.BertOutput with Bert->Roberta->Camembert
...
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaLayer with Roberta->Camembert
...
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaEncoder with Roberta->Camembert
...
# Copied from transformers_4571.models.bert.modeling_bert.BertPooler
...
class CamembertPreTrainedModel(PreTrainedModel):
    ...
    # Copied from transformers_4571.models.bert.modeling_bert.BertPreTrainedModel._init_weights with BertLMPredictionHead->CamembertLMHead
...
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaClassificationHead with Roberta->Camembert
...
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaLMHead with Roberta->Camembert
...
class CamembertModel(CamembertPreTrainedModel):
    ...
    # Copied from transformers_4571.models.roberta.modeling_roberta.RobertaModel.__init__ with Roberta->Camembert
    ...
    @auto_docstring
    # Copied from transformers_4571.models.roberta.modeling_roberta.RobertaModel.forward
    def forward(
        self,
...
@auto_docstring
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaForMaskedLM with Roberta->Camembert, ROBERTA->CAMEMBERT
...
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaForSequenceClassification with Roberta->Camembert, ROBERTA->CAMEMBERT
...
@auto_docstring
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaForMultipleChoice with Roberta->Camembert, ROBERTA->CAMEMBERT
...
@auto_docstring
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaForTokenClassification with Roberta->Camembert, ROBERTA->CAMEMBERT
...
@auto_docstring
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaForQuestionAnswering with Roberta->Camembert, ROBERTA->CAMEMBERT
...
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaForCausalLM with Roberta->Camembert, ROBERTA->CAMEMBERT, FacebookAI/roberta-base->almanach/camembert-base
class CamembertForCausalLM(CamembertPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, CamembertForCausalLM, AutoConfig
        >>> import torch
