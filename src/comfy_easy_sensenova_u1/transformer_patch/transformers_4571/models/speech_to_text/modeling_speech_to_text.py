...
# Copied from transformers_4571.models.musicgen.modeling_musicgen.MusicgenAttention with Musicgen->Speech2Text
...
# Copied from transformers_4571.models.mbart.modeling_mbart.MBartEncoderLayer with MBart->Speech2Text, MBART->SPEECH_TO_TEXT
...
# copied from transformers_4571.models.mbart.modeling_mbart.MBartDecoderLayer with MBart->Speech2Text, MBART->SPEECH_TO_TEXT
...
class Speech2TextDecoderLayer(GradientCheckpointingLayer):
    ...
    @deprecate_kwarg("past_key_value", new_name="past_key_values", version="4.58")
    # Copied from transformers_4571.models.musicgen.modeling_musicgen.MusicgenDecoderLayer.forward
    def forward(
        self,
        hidden_states: torch.Tensor,
        attention_mask: Optional[torch.Tensor] = None,
...
class Speech2TextDecoder(Speech2TextPreTrainedModel):
    ...
    # Copied from transformers_4571.models.musicgen.modeling_musicgen.MusicgenDecoder._update_causal_mask
    ...
    # Copied from transformers_4571.models.musicgen.modeling_musicgen.MusicgenDecoder._update_cross_attn_mask
...
class Speech2TextModel(Speech2TextPreTrainedModel):
    ...
    def forward(
        ...
        Example:
         ...
         ```python
         >>> import torch
         >>> from transformers_4571 import Speech2TextModel, AutoFeatureExtractor
...
class Speech2TextForConditionalGeneration(Speech2TextPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformers_4571 import Speech2TextProcessor, Speech2TextForConditionalGeneration
        >>> from datasets import load_dataset
