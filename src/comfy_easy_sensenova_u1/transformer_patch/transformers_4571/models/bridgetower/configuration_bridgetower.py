...
class BridgeTowerVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import BridgeTowerVisionConfig
...
class BridgeTowerTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import BridgeTowerTextConfig
...
class BridgeTowerConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import BridgeTowerModel, BridgeTowerConfig
