...
# Copied from transformers_4571.models.clip.modeling_clip.CLIPVisionEmbeddings with CLIP->BridgeTower
...
# Copied from transformers_4571.models.bert.modeling_bert.BertSelfOutput with Bert->BridgeTower
...
# Copied from transformers_4571.models.bert.modeling_bert.BertIntermediate with Bert->BridgeTower
...
# Copied from transformers_4571.models.bert.modeling_bert.BertOutput with Bert->BridgeTower
...
# Copied from transformers_4571.models.bert.modeling_bert.BertPooler with Bert->BridgeTower
...
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaSelfAttention with Roberta->BridgeTower
...
# Copied from transformers_4571.models.bert.modeling_bert.BertAttention with Bert->BridgeTower,BERT->BRIDGE_TOWER
...
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaEncoder with Roberta->BridgeTowerText
...
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaEmbeddings with Roberta->BridgeTowerText
...
class BridgeTowerModel(BridgeTowerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import BridgeTowerProcessor, BridgeTowerModel
...
# Copied from transformers_4571.models.vilt.modeling_vilt.ViltPredictionHeadTransform with Vilt->BridgeTower
...
class BridgeTowerForMaskedLM(BridgeTowerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import BridgeTowerProcessor, BridgeTowerForMaskedLM
        >>> from PIL import Image
        >>> import requests
...
class BridgeTowerForImageAndTextRetrieval(BridgeTowerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import BridgeTowerProcessor, BridgeTowerForImageAndTextRetrieval
        >>> import requests
        >>> from PIL import Image
...
class BridgeTowerForContrastiveLearning(BridgeTowerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import BridgeTowerProcessor, BridgeTowerForContrastiveLearning
        >>> import requests
        >>> from PIL import Image
        >>> import torch
