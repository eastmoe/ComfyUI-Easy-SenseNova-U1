...
class NougatImageProcessor(BaseImageProcessor):
    ...
    # Copied from transformers_4571.models.donut.image_processing_donut.DonutImageProcessor.align_long_axis
    def align_long_axis(
        self,
        image: np.ndarray,
        size: dict[str, int],
    ...
    # Copied from transformers_4571.models.donut.image_processing_donut.DonutImageProcessor.thumbnail
    def thumbnail(
        self,
        image: np.ndarray,
        size: dict[str, int],
    ...
    # Copied from transformers_4571.models.donut.image_processing_donut.DonutImageProcessor.resize
    def resize(
        self,
        image: np.ndarray,
        size: dict[str, int],
