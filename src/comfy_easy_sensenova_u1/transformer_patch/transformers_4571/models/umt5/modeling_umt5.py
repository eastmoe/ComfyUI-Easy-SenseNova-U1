...
# Copied from transformers_4571.models.t5.modeling_t5.T5LayerNorm with T5->UMT5
...
# Copied from transformers_4571.models.t5.modeling_t5.T5DenseActDense with T5->UMT5
...
# Copied from transformers_4571.models.t5.modeling_t5.T5DenseGatedActDense with T5->UMT5
...
# Copied from transformers_4571.models.t5.modeling_t5.T5LayerFF with T5->UMT5
...
# Copied from transformers_4571.models.t5.modeling_t5.T5ClassificationHead with T5->UMT5
...
class UMT5Model(UMT5PreTrainedModel):
    ...
    ```python
    >>> from transformers_4571 import UMT5Model, AutoTokenizer
    ...
    # Copied from transformers_4571.models.t5.modeling_t5.T5Model._tie_weights
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, UMT5Model
...
class UMT5ForConditionalGeneration(UMT5PreTrainedModel, GenerationMixin):
    ...
    ```python
    >>> from transformers_4571 import UMT5ForConditionalGeneration, AutoTokenizer
    ...
    # Copied from transformers_4571.models.t5.modeling_t5.T5ForConditionalGeneration.get_input_embeddings
    def get_input_embeddings(self):
        return self.shared

    # Copied from transformers_4571.models.t5.modeling_t5.T5ForConditionalGeneration.set_input_embeddings
    def set_input_embeddings(self, new_embeddings):
        self.shared = new_embeddings
        self.encoder.set_input_embeddings(new_embeddings)
        self.decoder.set_input_embeddings(new_embeddings)

    # Copied from transformers_4571.models.t5.modeling_t5.T5ForConditionalGeneration._tie_weights
    def _tie_weights(self):
        if self.config.tie_word_embeddings:
            self._tie_or_clone_weights(self.encoder.embed_tokens, self.shared)
            self._tie_or_clone_weights(self.decoder.embed_tokens, self.shared)
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, UMT5ForConditionalGeneration
...
class UMT5EncoderModel(UMT5PreTrainedModel):
    ...
    ```python
    >>> from transformers_4571 import UMT5EncoderModel, AutoTokenizer
    ...
    # Copied from transformers_4571.models.t5.modeling_t5.T5EncoderModel._tie_weights
    def _tie_weights(self):
        if self.config.tie_word_embeddings:
            self._tie_or_clone_weights(self.encoder.embed_tokens, self.shared)
    ...
    @auto_docstring
    # Copied from transformers_4571.models.t5.modeling_t5.T5EncoderModel.forward with T5->UMT5, google-t5/t5-small->google/umt5-small, t5#training->umt5#training
    def forward(
        self,
        input_ids: Optional[torch.LongTensor] = None,
        attention_mask: Optional[torch.FloatTensor] = None,
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, UMT5EncoderModel
...
class UMT5ForSequenceClassification(UMT5PreTrainedModel):
    ...
    # Copied from transformers_4571.models.t5.modeling_t5.T5ForSequenceClassification.__init__ with T5->UMT5
    def __init__(self, config: UMT5Config):
        super().__init__(config)
...
class UMT5ForTokenClassification(UMT5PreTrainedModel):
    ...
    # Copied from transformers_4571.models.t5.modeling_t5.T5ForTokenClassification.__init__ with T5->UMT5
    def __init__(self, config: UMT5Config):
        super().__init__(config)
    ...
    @auto_docstring
    # Copied from transformers_4571.models.t5.modeling_t5.T5ForTokenClassification.forward with T5->UMT5, t5->umt5
    def forward(
        self,
...
class UMT5ForQuestionAnswering(UMT5PreTrainedModel):
    ...
    # Copied from transformers_4571.models.t5.modeling_t5.T5ForQuestionAnswering._tie_weights
    def _tie_weights(self):
        if self.config.tie_word_embeddings:
            self._tie_or_clone_weights(self.encoder.embed_tokens, self.shared)
            self._tie_or_clone_weights(self.decoder.embed_tokens, self.shared)
