...
# Copied from transformers_4571.models.llama.modeling_llama.LlamaRMSNorm with Llama->Zamba
...
class ZambaHybridDynamicCache:
    ...
    # Copied from transformers_4571.models.jamba.modeling_jamba.HybridMambaAttentionDynamicCache.update
    def update(
        self,
    ...
    # Copied from transformers_4571.models.jamba.modeling_jamba.HybridMambaAttentionDynamicCache.reorder_cache
    ...
    # Copied from transformers_4571.models.jamba.modeling_jamba.HybridMambaAttentionDynamicCache.get_seq_length
...
class ZambaAttention(nn.Module):
    ...
    Adapted from transformers_4571.models.mistral.modeling_mistral.MistralAttention:
...
# Copied from transformers_4571.models.mistral.modeling_mistral.MistralMLP with Mistral->Zamba
...
class ZambaModel(ZambaPreTrainedModel):
    ...
    # Copied from transformers_4571.models.jamba.modeling_jamba.JambaModel._update_causal_mask
...
# Adapted from transformers_4571.models.jamba.modeling_jamba.JambaForCausalLM with Jamba->Zamba, JAMBA->ZAMBA
class ZambaForCausalLM(ZambaPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, ZambaForCausalLM
