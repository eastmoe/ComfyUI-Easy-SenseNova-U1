...
# Copied from transformers_4571.models.llava.modeling_llava.LlavaMultiModalProjector with Llava->VideoLlava
...
class VideoLlavaForConditionalGeneration(VideoLlavaPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> from transformers_4571 import VideoLlavaProcessor, VideoLlavaForConditionalGeneration
