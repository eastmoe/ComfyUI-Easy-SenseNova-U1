...
class Idefics3VisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571.models.idefics3.modeling_idefics3 import Idefics3VisionTransformer
    >>> from transformers_4571.models.idefics3.configuration_idefics3 import Idefics3VisionConfig
...
class Idefics3Config(PretrainedConfig):
    ...
    Example:
    ```python
    >>> from transformers_4571 import Idefics3Model, Idefics3Config
