...
# Copied from transformers_4571.models.llama.modeling_llama.LlamaRMSNorm with Llama->Chameleon
...
# copied from transformers_4571.models.llama.modeling_llama.LlamaRotaryEmbedding with Llama->Chameleon
...
# Copied from transformers_4571.models.llama.modeling_llama.LlamaMLP with Llama->Chameleon
...
class ChameleonAttention(nn.Module):
    ...
    # copied from transformers_4571.models.llama.modeling_llama.LlamaAttention._init_rope with Llama->Chameleon
    # TODO(joao): add me back asap :)
    def _init_rope(self):
...
# copied from transformers_4571.models.llama.modeling_llama.LlamaDecoderLayer with Llama->Chameleon, LLAMA->CHAMELEON
...
class ChameleonForConditionalGeneration(ChameleonPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        ```python
        >>> from transformers_4571 import ChameleonProcessor, ChameleonForConditionalGeneration
        >>> import torch
        >>> import requests
