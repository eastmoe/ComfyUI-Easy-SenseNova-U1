...
# Copied from transformers_4571.models.swin.modeling_swin.SwinDropPath with Swin->Swin2SR
...
# Copied from transformers_4571.models.swinv2.modeling_swinv2.Swinv2PatchMerging with Swinv2->Swin2SR
...
# Copied from transformers_4571.models.swinv2.modeling_swinv2.Swinv2SelfAttention with Swinv2->Swin2SR
...
# Copied from transformers_4571.models.swin.modeling_swin.SwinSelfOutput with Swin->Swin2SR
...
# Copied from transformers_4571.models.swinv2.modeling_swinv2.Swinv2Attention with Swinv2->Swin2SR
...
# Copied from transformers_4571.models.swin.modeling_swin.SwinIntermediate with Swin->Swin2SR
...
# Copied from transformers_4571.models.swin.modeling_swin.SwinOutput with Swin->Swin2SR
...
# Copied from transformers_4571.models.swinv2.modeling_swinv2.Swinv2Layer with Swinv2->Swin2SR
...
class Swin2SRForImageSuperResolution(Swin2SRPreTrainedModel):
    ...
    def forward(
        ...
        Example:
         ...
         >>> from transformers_4571 import AutoImageProcessor, Swin2SRForImageSuperResolution
