...
# Copied from transformers_4571.models.bert.modeling_tf_bert.TFBertPreTrainingLoss
...
class TFMobileBertForPreTraining(TFMobileBertPreTrainedModel, TFMobileBertPreTrainingLoss):
    ...
    def call(
        ...
        ```python
        >>> import tensorflow as tf
        >>> from transformers_4571 import AutoTokenizer, TFMobileBertForPreTraining
...
class TFMobileBertForNextSentencePrediction(TFMobileBertPreTrainedModel, TFNextSentencePredictionLoss):
    ...
    def call(
        ...
        ```python
        >>> import tensorflow as tf
        >>> from transformers_4571 import AutoTokenizer, TFMobileBertForNextSentencePrediction
