...
class MobileBertConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import MobileBertConfig, MobileBertModel
...
# Copied from transformers_4571.models.bert.configuration_bert.BertOnnxConfig with Bert->MobileBert
