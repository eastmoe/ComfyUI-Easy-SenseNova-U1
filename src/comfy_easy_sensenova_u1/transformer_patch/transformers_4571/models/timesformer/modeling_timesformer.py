...
# Copied from transformers_4571.models.beit.modeling_beit.BeitDropPath with Beit->TimeSformer
...
class TimesformerModel(TimesformerPreTrainedModel):
    ...
    def forward(
        ...
        >>> from transformers_4571 import AutoImageProcessor, TimesformerModel
...
class TimesformerForVideoClassification(TimesformerPreTrainedModel):
    ...
    def forward(
        ...
        >>> from transformers_4571 import AutoImageProcessor, TimesformerForVideoClassification
        >>> from huggingface_hub import hf_hub_download
