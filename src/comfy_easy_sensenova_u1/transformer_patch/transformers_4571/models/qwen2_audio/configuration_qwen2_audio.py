...
class Qwen2AudioEncoderConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import Qwen2AudioEncoderConfig, Qwen2AudioEncoder
...
class Qwen2AudioConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import Qwen2AudioForConditionalGeneration, Qwen2AudioConfig, Qwen2AudioEncoderConfig, Qwen2Config
