...
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaEmbeddings with Roberta->RobertaPreLayerNorm
...
# Copied from transformers_4571.models.bert.modeling_bert.BertSelfAttention with Bert->RobertaPreLayerNorm
...
class RobertaPreLayerNormAttention(nn.Module):
    ...
    # Copied from transformers_4571.models.bert.modeling_bert.BertAttention.prune_heads
...
# Copied from transformers_4571.models.bert.modeling_bert.BertLayer with Bert->RobertaPreLayerNorm
...
# Copied from transformers_4571.models.bert.modeling_bert.BertEncoder with Bert->RobertaPreLayerNorm
...
class RobertaPreLayerNormPreTrainedModel(PreTrainedModel):
    ...
    # Copied from transformers_4571.models.bert.modeling_bert.BertPreTrainedModel._init_weights with BertLMPredictionHead->RobertaPreLayerNormLMHead
...
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaForCausalLM with FacebookAI/roberta-base->andreasmadsen/efficient_mlm_m0.40,ROBERTA->ROBERTA_PRELAYERNORM,Roberta->RobertaPreLayerNorm,roberta->roberta_prelayernorm, RobertaPreLayerNormTokenizer->RobertaTokenizer
class RobertaPreLayerNormForCausalLM(RobertaPreLayerNormPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, RobertaPreLayerNormForCausalLM, AutoConfig
        >>> import torch
...
class RobertaPreLayerNormForMaskedLM(RobertaPreLayerNormPreTrainedModel):
    ...
    # Copied from transformers_4571.models.roberta.modeling_roberta.RobertaForMaskedLM.__init__ with ROBERTA->ROBERTA_PRELAYERNORM,Roberta->RobertaPreLayerNorm,roberta->roberta_prelayernorm
    def __init__(self, config):
        super().__init__(config)
    ...
    @auto_docstring
    # Copied from transformers_4571.models.roberta.modeling_roberta.RobertaForMaskedLM.forward with ROBERTA->ROBERTA_PRELAYERNORM,Roberta->RobertaPreLayerNorm,roberta->roberta_prelayernorm
    def forward(
        self,
        input_ids: Optional[torch.LongTensor] = None,
        attention_mask: Optional[torch.FloatTensor] = None,
...
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaLMHead with Roberta->RobertaPreLayerNorm
...
class RobertaPreLayerNormForSequenceClassification(RobertaPreLayerNormPreTrainedModel):
    ...
    @auto_docstring
    # Copied from transformers_4571.models.roberta.modeling_roberta.RobertaForSequenceClassification.forward with roberta->roberta_prelayernorm
    def forward(
        self,
        input_ids: Optional[torch.LongTensor] = None,
        attention_mask: Optional[torch.FloatTensor] = None,
...
@auto_docstring
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaForMultipleChoice with ROBERTA->ROBERTA_PRELAYERNORM,Roberta->RobertaPreLayerNorm,roberta->roberta_prelayernorm
...
class RobertaPreLayerNormForTokenClassification(RobertaPreLayerNormPreTrainedModel):
    ...
    @auto_docstring
    # Copied from transformers_4571.models.roberta.modeling_roberta.RobertaForTokenClassification.forward with roberta->roberta_prelayernorm
    def forward(
        self,
        input_ids: Optional[torch.LongTensor] = None,
        attention_mask: Optional[torch.FloatTensor] = None,
...
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaClassificationHead with Roberta->RobertaPreLayerNorm
...
class RobertaPreLayerNormForQuestionAnswering(RobertaPreLayerNormPreTrainedModel):
    ...
    @auto_docstring
    # Copied from transformers_4571.models.roberta.modeling_roberta.RobertaForQuestionAnswering.forward with roberta->roberta_prelayernorm
    def forward(
        self,
        input_ids: Optional[torch.LongTensor] = None,
        attention_mask: Optional[torch.FloatTensor] = None,
