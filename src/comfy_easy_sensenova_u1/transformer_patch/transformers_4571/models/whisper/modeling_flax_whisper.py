...
# Copied from transformers_4571.models.mbart.modeling_flax_mbart.FlaxMBartEncoderLayer with MBart->Whisper
...
# Copied from transformers_4571.models.mbart.modeling_flax_mbart.FlaxMBartDecoderLayer with MBart->Whisper
...
class FlaxWhisperPreTrainedModel(FlaxPreTrainedModel):
    ...
    # Copied from transformers_4571.models.bart.modeling_flax_bart.FlaxBartPreTrainedModel.init_cache with Bart->Whisper
    ...
    def encode(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_4571 import WhisperProcessor, FlaxWhisperForConditionalGeneration
...
FLAX_WHISPER_AUDIO_CLASSIFICATION_DOCSTRING = r"""
    ...
    ```python
    >>> import jax.numpy as jnp
    >>> from transformers_4571 import AutoFeatureExtractor, FlaxWhisperForAudioClassification
    >>> from datasets import load_dataset
