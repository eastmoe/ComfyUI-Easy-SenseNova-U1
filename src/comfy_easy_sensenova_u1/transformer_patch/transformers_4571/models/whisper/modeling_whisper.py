...
# Copied from transformers_4571.models.mbart.modeling_mbart.MBartEncoderLayer with MBart->Whisper, MBART->WHISPER
...
class WhisperModel(WhisperPreTrainedModel):
    ...
    def forward(
        ...
        Example:
         ```python
         >>> import torch
         >>> from transformers_4571 import AutoFeatureExtractor, WhisperModel
...
class WhisperForCausalLM(WhisperPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import WhisperForCausalLM, WhisperForConditionalGeneration, WhisperProcessor
        >>> import torch
        >>> from datasets import load_dataset
...
class WhisperForAudioClassification(WhisperPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformers_4571 import AutoFeatureExtractor, WhisperForAudioClassification
        >>> from datasets import load_dataset
