...
# Copied from transformers_4571.models.gpt2.tokenization_gpt2.bytes_to_unicode
...
# Copied from transformers_4571.models.gpt2.tokenization_gpt2.get_pairs
def get_pairs(word):
    """
...
class WhisperTokenizer(PreTrainedTokenizer):
    ...
    # Copied from transformers_4571.models.gpt2.tokenization_gpt2.GPT2Tokenizer.bpe with GPT2 -> Whisper
    def bpe(self, token):
    ...
    # Copied from transformers_4571.models.speech_to_text.tokenization_speech_to_text.Speech2TextTokenizer.build_inputs_with_special_tokens
    ...
    # Copied from transformers_4571.models.speech_to_text.tokenization_speech_to_text.Speech2TextTokenizer.get_special_tokens_mask
    ...
    # Copied from transformers_4571.models.gpt2.tokenization_gpt2.GPT2Tokenizer._tokenize with GPT2 -> Whisper
    ...
    # Copied from transformers_4571.models.gpt2.tokenization_gpt2.GPT2Tokenizer._convert_token_to_id with GPT2 -> Whisper
    ...
    # Copied from transformers_4571.models.gpt2.tokenization_gpt2.GPT2Tokenizer.convert_tokens_to_string with GPT2 -> Whisper
    ...
    # Copied from transformers_4571.models.gpt2.tokenization_gpt2.GPT2Tokenizer.prepare_for_tokenization with GPT2 -> Whisper
