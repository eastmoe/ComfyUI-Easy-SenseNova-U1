...
# Copied from transformers_4571.models.clip.modeling_clip.CLIPMLP with CLIP->MllamaVision
...
# Copied from transformers_4571.models.llama.modeling_llama.eager_attention_forward
...
# Copied from transformers_4571.models.llama.modeling_llama.LlamaRMSNorm with Llama->MllamaText
...
# Copied from transformers_4571.models.gemma2.modeling_gemma2.Gemma2MLP with Gemma2->MllamaText
...
# Modified from transformers_4571.models.llama.modeling_llama.LlamaDecoderLayer
...
class MllamaVisionModel(MllamaPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, MllamaVisionModel
...
class MllamaTextModel(MllamaPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        ```python
        >>> from transformers_4571 import AutoProcessor, MllamaTextModel
...
class MllamaForCausalLM(MllamaPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, MllamaForCausalLM
...
class MllamaForConditionalGeneration(MllamaPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, MllamaForConditionalGeneration
