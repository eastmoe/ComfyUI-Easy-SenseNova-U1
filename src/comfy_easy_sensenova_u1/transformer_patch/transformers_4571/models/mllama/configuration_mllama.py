...
class MllamaVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import MllamaVisionConfig, MllamaVisionModel
...
class MllamaTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import MllamaTextModel, MllamaTextConfig
...
class MllamaConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import MllamaForConditionalGeneration, MllamaConfig, MllamaVisionConfig, MllamaTextConfig
