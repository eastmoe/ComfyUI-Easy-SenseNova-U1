...
# Copied from transformers_4571.models.bart.modeling_bart.BartScaledWordEmbedding with Bart->BigBirdPegasus
...
# Copied from transformers_4571.models.big_bird.modeling_big_bird.BigBirdSelfAttention with BigBird->BigBirdPegasus
...
# Copied from transformers_4571.models.big_bird.modeling_big_bird.BigBirdBlockSparseAttention with BigBird->BigBirdPegasus
...
# Copied from transformers_4571.models.bart.modeling_bart.eager_attention_forward
...
# Copied from transformers_4571.models.bart.modeling_bart.BartAttention with BartConfig->BigBirdPegasusConfig, Bart->BigBirdPegasusDecoder
...
class BigBirdPegasusDecoderLayer(GradientCheckpointingLayer):
    ...
    # Copied from transformers_4571.models.mbart.modeling_mbart.MBartDecoderLayer.forward
    def forward(
        self,
        hidden_states: torch.Tensor,
        attention_mask: Optional[torch.Tensor] = None,
...
# Copied from transformers_4571.models.bart.modeling_bart.BartClassificationHead with Bart->BigBirdPegasus
...
class BigBirdPegasusPreTrainedModel(PreTrainedModel):
    ...
    # Copied from transformers_4571.models.bart.modeling_bart.BartPreTrainedModel._update_causal_mask
    ...
    # Copied from transformers_4571.models.bart.modeling_bart.BartPreTrainedModel._update_cross_attn_mask
...
class BigBirdPegasusEncoder(BigBirdPegasusPreTrainedModel):
    ...
    @staticmethod  # Copied from transformers_4571.models.big_bird.modeling_big_bird.BigBirdModel.create_masks_for_block_sparse_attn
...
# Copied from transformers_4571.models.bart.modeling_bart.BartForConditionalGeneration with Bart->BigBirdPegasus, BART->BIGBIRD_PEGASUS
class BigBirdPegasusForConditionalGeneration(BigBirdPegasusPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, BigBirdPegasusForConditionalGeneration
...
# Copied from transformers_4571.models.pegasus.modeling_pegasus.PegasusDecoderWrapper with Pegasus->BigBirdPegasus
...
class BigBirdPegasusForCausalLM(BigBirdPegasusPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, BigBirdPegasusForCausalLM
