...
@dataclass
@auto_docstring
# Copied from transformers_4571.models.clip.modeling_clip.CLIPOutput with CLIP->AltCLIP
...
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaEmbeddings with Roberta->AltRoberta
...
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaSelfOutput
...
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaIntermediate with Roberta->AltRoberta
...
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaOutput
...
# Copied from transformers_4571.models.align.modeling_align.AlignTextLayer with AlignText->AltRoberta
...
# Copied from transformers_4571.models.align.modeling_align.AlignTextEncoder with AlignText->AltRoberta
...
# Copied from transformers_4571.models.clip.modeling_clip.CLIPMLP with CLIP->AltCLIP
...
# Copied from transformers_4571.models.clip.modeling_clip.CLIPVisionEmbeddings with CLIP->AltCLIP
...
class AltCLIPVisionModel(AltCLIPPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, AltCLIPVisionModel
...
class AltRobertaModel(AltCLIPPreTrainedModel):
    ...
    # Copied from transformers_4571.models.clap.modeling_clap.ClapTextModel.__init__ with ClapText->AltRoberta
    ...
    @auto_docstring
    # Copied from transformers_4571.models.clap.modeling_clap.ClapTextModel.forward
    def forward(
        self,
...
class AltCLIPTextModel(AltCLIPPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoProcessor, AltCLIPTextModel
...
class AltCLIPModel(AltCLIPPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> import torch
        >>> from transformers_4571 import AutoProcessor, AltCLIPModel
