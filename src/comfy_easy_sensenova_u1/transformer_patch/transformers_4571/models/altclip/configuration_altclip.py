...
class AltCLIPTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import AltCLIPTextModel, AltCLIPTextConfig
...
class AltCLIPVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import AltCLIPVisionConfig, AltCLIPVisionModel
...
class AltCLIPConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import AltCLIPConfig, AltCLIPModel
