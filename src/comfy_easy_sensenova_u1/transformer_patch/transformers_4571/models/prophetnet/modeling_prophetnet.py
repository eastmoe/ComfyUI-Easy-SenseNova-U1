...
class ProphetNetEncoder(ProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, ProphetNetEncoder
        >>> import torch
...
class ProphetNetDecoder(ProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, ProphetNetDecoder
        >>> import torch
...
class ProphetNetModel(ProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, ProphetNetModel
...
class ProphetNetForConditionalGeneration(ProphetNetPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, ProphetNetForConditionalGeneration
...
class ProphetNetForCausalLM(ProphetNetPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, ProphetNetForCausalLM
        >>> import torch
