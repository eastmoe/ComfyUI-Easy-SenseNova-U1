...
# Copied from transformers_4571.models.maskformer.image_processing_maskformer.convert_segmentation_map_to_binary_masks
...
# Copied from transformers_4571.models.maskformer.image_processing_maskformer.get_maskformer_resize_output_image_size with maskformer->mask2former
...
class Mask2FormerImageProcessor(BaseImageProcessor):
    ...
    # Copied from transformers_4571.models.maskformer.image_processing_maskformer.MaskFormerImageProcessor.to_dict
    ...
    # Copied from transformers_4571.models.maskformer.image_processing_maskformer.MaskFormerImageProcessor.resize with get_maskformer_resize_output_image_size->get_mask2former_resize_output_image_size
    def resize(
        self,
        image: np.ndarray,
        size: dict[str, int],
    ...
    # Copied from transformers_4571.models.maskformer.image_processing_maskformer.MaskFormerImageProcessor.convert_segmentation_map_to_binary_masks
    def convert_segmentation_map_to_binary_masks(
        self,
        segmentation_map: np.ndarray,
        instance_id_to_semantic_id: Optional[dict[int, int]] = None,
    ...
    # Copied from transformers_4571.models.vilt.image_processing_vilt.ViltImageProcessor._pad_image
    def _pad_image(
        self,
        image: np.ndarray,
        output_size: tuple[int, int],
    ...
    # Copied from transformers_4571.models.maskformer.image_processing_maskformer.MaskFormerImageProcessor.pad
    def pad(
        self,
