...
# Copied from transformers_4571.models.llama.modeling_llama.LlamaRMSNorm with Llama->Qwen2Moe
...
# Copied from transformers_4571.models.llama.modeling_llama.LlamaRotaryEmbedding with Llama->Qwen2Moe
...
# Modified from transformers_4571.models.mistral.modeling_mistral.MistralMLP with Mistral->Qwen2Moe
...
# copied from transformers_4571.models.qwen2.modeling_qwen2.Qwen2Attention with Qwen2->Qwen2Moe
...
# NO LONGER EXIST Copied from transformers_4571.models.qwen2.modeling_qwen2.Qwen2FlashAttention2 with Qwen2->Qwen2Moe
# TODO cyril: modular
...
# NO LONGER EXIST Copied from transformers_4571.models.qwen2.modeling_qwen2.Qwen2SdpaAttention with Qwen2->Qwen2Moe
# TODO cyril: modular
...
class Qwen2MoeModel(Qwen2MoePreTrainedModel):
    ...
    # Copied from transformers_4571.models.phimoe.modeling_phimoe.PhimoeModel._update_causal_mask with Phimoe->Qwen2Moe
    ...
    @staticmethod
    # Copied from transformers_4571.models.phimoe.modeling_phimoe.PhimoeModel._prepare_4d_causal_attention_mask_with_cache_position with Phimoe->Qwen2Moe
...
class Qwen2MoeForCausalLM(Qwen2MoePreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, Qwen2MoeForCausalLM
