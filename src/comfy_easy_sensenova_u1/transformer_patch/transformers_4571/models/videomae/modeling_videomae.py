...
# Copied from transformers_4571.models.vit.modeling_vit.ViTSelfOutput with ViT->VideoMAE
...
# Copied from transformers_4571.models.vit.modeling_vit.ViTAttention with ViT->VideoMAE
...
# Copied from transformers_4571.models.vit.modeling_vit.ViTIntermediate ViT->VideoMAE
...
# Copied from transformers_4571.models.vit.modeling_vit.ViTOutput ViT->VideoMAE
...
# Copied from transformers_4571.models.vit.modeling_vit.ViTLayer with ViT->VideoMAE,VIT->VIDEOMAE
...
# Copied from transformers_4571.models.vit.modeling_vit.ViTEncoder with ViT->VideoMAE
...
class VideoMAEModel(VideoMAEPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> from transformers_4571 import AutoImageProcessor, VideoMAEModel
...
class VideoMAEForPreTraining(VideoMAEPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        Examples:
        ```python
        >>> from transformers_4571 import AutoImageProcessor, VideoMAEForPreTraining
        >>> import numpy as np
        >>> import torch
...
class VideoMAEForVideoClassification(VideoMAEPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> from transformers_4571 import AutoImageProcessor, VideoMAEForVideoClassification
        >>> from huggingface_hub import hf_hub_download
