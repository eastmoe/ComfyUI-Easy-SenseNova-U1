...
# Copied from transformers_4571.models.bert.modeling_tf_bert.TFBertSelfAttention with Bert->Tapas
...
# Copied from transformers_4571.models.bert.modeling_tf_bert.TFBertSelfOutput with Bert->Tapas
...
# Copied from transformers_4571.models.bert.modeling_tf_bert.TFBertAttention with Bert->Tapas
...
# Copied from transformers_4571.models.bert.modeling_tf_bert.TFBertIntermediate with Bert->Tapas
...
# Copied from transformers_4571.models.bert.modeling_tf_bert.TFBertOutput with Bert->Tapas
...
# Copied from transformers_4571.models.bert.modeling_tf_bert.TFBertLayer with Bert->Tapas
...
# Copied from transformers_4571.models.bert.modeling_tf_bert.TFBertEncoder with Bert->Tapas
...
# Copied from transformers_4571.models.bert.modeling_tf_bert.TFBertPooler with Bert->Tapas
...
# Copied from transformers_4571.models.bert.modeling_tf_bert.TFBertPredictionHeadTransform with Bert->Tapas
...
# Copied from transformers_4571.models.bert.modeling_tf_bert.TFBertLMPredictionHead with Bert->Tapas
...
# Copied from transformers_4571.models.bert.modeling_tf_bert.TFBertMLMHead with Bert->Tapas
...
class TFTapasModel(TFTapasPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, TapasModel
        >>> import pandas as pd
...
class TFTapasForMaskedLM(TFTapasPreTrainedModel, TFMaskedLanguageModelingLoss):
    ...
    def call(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, TapasForMaskedLM
        >>> import pandas as pd
...
class TFTapasForQuestionAnswering(TFTapasPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, TapasForQuestionAnswering
        >>> import pandas as pd
...
class TFTapasForSequenceClassification(TFTapasPreTrainedModel, TFSequenceClassificationLoss):
    ...
    def call(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, TapasForSequenceClassification
        >>> import tensorflow as tf
        >>> import pandas as pd
