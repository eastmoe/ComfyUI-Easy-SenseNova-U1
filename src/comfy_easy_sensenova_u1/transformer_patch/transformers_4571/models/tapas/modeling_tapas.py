...
class TapasAttention(nn.Module):
    ...
    # Copied from transformers_4571.models.bert.modeling_bert.BertAttention.forward
    def forward(
        self,
...
class TapasLayer(GradientCheckpointingLayer):
    ...
    # Copied from transformers_4571.models.bert.modeling_bert.BertLayer.forward
    def forward(
        self,
        hidden_states: torch.Tensor,
        attention_mask: Optional[torch.FloatTensor] = None,
...
# Copied from transformers_4571.models.bert.modeling_bert.BertPredictionHeadTransform with Bert->Tapas
...
# Copied from transformers_4571.models.bert.modeling_bert.BertLMPredictionHead with Bert->Tapas
...
# Copied from transformers_4571.models.bert.modeling_bert.BertOnlyMLMHead with Bert->Tapas
...
class TapasPreTrainedModel(PreTrainedModel):
    ...
    # Copied from transformers_4571.models.bert.modeling_bert.BertPreTrainedModel._init_weights with Bert->Tapas
