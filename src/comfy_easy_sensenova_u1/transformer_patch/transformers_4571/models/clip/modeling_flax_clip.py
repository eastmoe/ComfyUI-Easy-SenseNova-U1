...
class FlaxCLIPPreTrainedModel(FlaxPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, FlaxCLIPModel
    ...
    def get_image_features(
        ...
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, FlaxCLIPModel
...
FLAX_CLIP_TEXT_MODEL_DOCSTRING = """
    ...
    ```python
    >>> from transformers_4571 import AutoTokenizer, FlaxCLIPTextModel
...
FLAX_CLIP_TEXT_MODEL_WITH_PROJECTION_DOCSTRING = """
    ...
    ```python
    >>> from transformers_4571 import AutoTokenizer, FlaxCLIPTextModelWithProjection
...
FLAX_CLIP_VISION_MODEL_DOCSTRING = """
    ...
    >>> from PIL import Image
    >>> import requests
    >>> from transformers_4571 import AutoProcessor, FlaxCLIPVisionModel
