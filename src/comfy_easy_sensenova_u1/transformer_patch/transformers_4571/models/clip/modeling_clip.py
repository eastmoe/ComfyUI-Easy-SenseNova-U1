...
class CLIPTextModel(CLIPPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, CLIPTextModel
...
class CLIPVisionModel(CLIPPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, CLIPVisionModel
...
class CLIPModel(CLIPPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> import torch
        >>> from transformers_4571 import AutoTokenizer, CLIPModel
    ...
    def get_image_features(
        ...
        ```python
        >>> import torch
        >>> from transformers_4571 import AutoProcessor, CLIPModel
...
class CLIPTextModelWithProjection(CLIPPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformers_4571 import AutoTokenizer, CLIPTextModelWithProjection
...
class CLIPVisionModelWithProjection(CLIPPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformers_4571 import AutoProcessor, CLIPVisionModelWithProjection
        >>> from transformers_4571.image_utils import load_image
