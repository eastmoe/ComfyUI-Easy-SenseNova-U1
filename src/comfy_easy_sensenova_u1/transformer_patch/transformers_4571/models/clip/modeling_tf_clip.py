...
class TFCLIPTextModel(TFCLIPPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, TFCLIPTextModel
...
class TFCLIPVisionModel(TFCLIPPreTrainedModel):
    ...
    def call(
        ...
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, TFCLIPVisionModel
...
class TFCLIPModel(TFCLIPPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, TFCLIPModel
    ...
    def get_image_features(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, TFCLIPModel
