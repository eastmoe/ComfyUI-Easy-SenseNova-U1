...
class CLIPTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import CLIPTextConfig, CLIPTextModel
...
class CLIPVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import CLIPVisionConfig, CLIPVisionModel
...
class CLIPConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import CLIPConfig, CLIPModel
    ...
    >>> from transformers_4571 import CLIPTextConfig, CLIPVisionConfig
