...
class MBart50Tokenizer(PreTrainedTokenizer):
    ...
    ```python
    >>> from transformers_4571 import MBart50Tokenizer
    ...
    # Copied from transformers_4571.models.albert.tokenization_albert.AlbertTokenizer.convert_tokens_to_string
