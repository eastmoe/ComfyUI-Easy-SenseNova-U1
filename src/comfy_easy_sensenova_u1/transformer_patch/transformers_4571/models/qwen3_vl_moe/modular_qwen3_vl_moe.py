...
class Qwen3VLMoeTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import Qwen3VLMoeForConditionalGeneration, Qwen3VLMoeConfig
...
class Qwen3VLMoeForConditionalGeneration(Qwen3VLForConditionalGeneration):
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, Qwen3VLMoeForConditionalGeneration
