...
# Copied from transformers_4571.models.deformable_detr.modeling_deformable_detr.MultiScaleDeformableAttention
...
# Copied from transformers_4571.models.detr.modeling_detr.DetrFrozenBatchNorm2d with Detr->GroundingDino
...
# Copied from transformers_4571.models.detr.modeling_detr.replace_batch_norm with Detr->GroundingDino
...
class GroundingDinoConvEncoder(nn.Module):
    ...
    # Copied from transformers_4571.models.detr.modeling_detr.DetrConvEncoder.forward with Detr->GroundingDino
...
# Copied from transformers_4571.models.detr.modeling_detr.DetrConvModel with Detr->GroundingDino
...
# Copied from transformers_4571.models.deformable_detr.modeling_deformable_detr.DeformableDetrMultiscaleDeformableAttention with DeformableDetr->GroundingDino, Deformable DETR->Grounding DINO
...
# Copied from transformers_4571.models.beit.modeling_beit.BeitDropPath with Beit->GroundingDino
...
# Copied from transformers_4571.models.detr.modeling_detr.DetrMLPPredictionHead
...
class GroundingDinoForObjectDetection(GroundingDinoPreTrainedModel):
    ...
    def forward(
        ...
        >>> import torch
        >>> from PIL import Image
        >>> from transformers_4571 import AutoProcessor, AutoModelForZeroShotObjectDetection
