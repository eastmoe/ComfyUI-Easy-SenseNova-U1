...
class XmodConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import XmodConfig, XmodModel
...
# Copied from transformers_4571.models.roberta.configuration_roberta.RobertaOnnxConfig with Roberta->Xmod
