...
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaEmbeddings with Roberta->Xmod
...
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaSelfAttention with Roberta->Xmod
...
class XmodSelfOutput(nn.Module):
    # Copied from transformers_4571.models.roberta.modeling_roberta.RobertaSelfOutput.__init__
    def __init__(self, config):
        super().__init__()
...
class XmodAttention(nn.Module):
    ...
    # Copied from transformers_4571.models.roberta.modeling_roberta.RobertaAttention.prune_heads
...
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaIntermediate
...
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaPooler
...
class XmodPreTrainedModel(PreTrainedModel):
    ...
    # Copied from transformers_4571.models.bert.modeling_bert.BertPreTrainedModel._init_weights with BertLMPredictionHead->XmodLMHead
...
class XmodModel(XmodPreTrainedModel):
    # Copied from transformers_4571.models.clap.modeling_clap.ClapTextModel.__init__ with ClapText->Xmod
    ...
    # Copied from transformers_4571.models.roberta.modeling_roberta.RobertaModel.get_input_embeddings
    def get_input_embeddings(self):
        return self.embeddings.word_embeddings

    # Copied from transformers_4571.models.roberta.modeling_roberta.RobertaModel.set_input_embeddings
    def set_input_embeddings(self, value):
        self.embeddings.word_embeddings = value

    # Copied from transformers_4571.models.roberta.modeling_roberta.RobertaModel._prune_heads
...
class XmodForCausalLM(XmodPreTrainedModel, GenerationMixin):
    ...
    # Copied from transformers_4571.models.roberta.modeling_roberta.RobertaForCausalLM.__init__ with Roberta->Xmod
    def __init__(self, config):
        super().__init__(config)
    ...
    # Copied from transformers_4571.models.roberta.modeling_roberta.RobertaForCausalLM.get_output_embeddings
    def get_output_embeddings(self):
        return self.lm_head.decoder

    # Copied from transformers_4571.models.roberta.modeling_roberta.RobertaForCausalLM.set_output_embeddings
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, XmodForCausalLM, AutoConfig
        >>> import torch
...
class XmodForMaskedLM(XmodPreTrainedModel):
    ...
    # Copied from transformers_4571.models.roberta.modeling_roberta.RobertaForMaskedLM.__init__ with Roberta->Xmod
    def __init__(self, config):
        super().__init__(config)
    ...
    # Copied from transformers_4571.models.roberta.modeling_roberta.RobertaForMaskedLM.get_output_embeddings
    def get_output_embeddings(self):
        return self.lm_head.decoder

    # Copied from transformers_4571.models.roberta.modeling_roberta.RobertaForMaskedLM.set_output_embeddings
    def set_output_embeddings(self, new_embeddings):
        self.lm_head.decoder = new_embeddings
...
class XmodForSequenceClassification(XmodPreTrainedModel):
    # Copied from transformers_4571.models.roberta.modeling_roberta.RobertaForSequenceClassification.__init__ with Roberta->Xmod
    def __init__(self, config):
        super().__init__(config)
...
class XmodForMultipleChoice(XmodPreTrainedModel):
    # Copied from transformers_4571.models.roberta.modeling_roberta.RobertaForMultipleChoice.__init__ with Roberta->Xmod
    def __init__(self, config):
        super().__init__(config)
...
class XmodForTokenClassification(XmodPreTrainedModel):
    # Copied from transformers_4571.models.roberta.modeling_roberta.RobertaForTokenClassification.__init__ with Roberta->Xmod
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
...
# Copied from transformers_4571.models.roberta.modeling_roberta.RobertaClassificationHead
...
class XmodForQuestionAnswering(XmodPreTrainedModel):
    # Copied from transformers_4571.models.roberta.modeling_roberta.RobertaForQuestionAnswering.__init__ with Roberta->Xmod
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
