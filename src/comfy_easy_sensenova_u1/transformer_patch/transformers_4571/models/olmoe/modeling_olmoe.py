...
# Copied from transformers_4571.models.llama.modeling_llama.LlamaRotaryEmbedding with Llama->Olmoe
...
# Copied from transformers_4571.models.olmo.modeling_olmo.OlmoMLP with Olmo->Olmoe
...
class OlmoeForCausalLM(OlmoePreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, OlmoeForCausalLM
