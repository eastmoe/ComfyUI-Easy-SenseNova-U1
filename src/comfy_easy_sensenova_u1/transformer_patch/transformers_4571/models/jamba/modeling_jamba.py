...
# Copied from transformers_4571.models.qwen2_moe.modeling_qwen2_moe.load_balancing_loss_func with gate->router
...
# Copied from transformers_4571.models.llama.modeling_llama.LlamaRMSNorm with Llama->Jamba
...
# Adapted from transformers_4571.models.mistral.modeling_mistral.MistralAttention with Mistral->Jamba
...
# Adapted from transformers_4571.models.mistral.modeling_mistral.MistralFlashAttention2 with Mistral->Jamba
...
# Adapted from transformers_4571.models.mistral.modeling_mistral.MistralSdpaAttention with Mistral->Jamba
...
# Adapted from transformers_4571.models.mamba.modeling_mamba.MambaMixer
...
# Copied from transformers_4571.models.mistral.modeling_mistral.MistralMLP with Mistral->Jamba
...
# Adapted from transformers_4571.models.mixtral.modeling_mixtral.MixtralSparseMoeBlock with Mistral->Jamba
...
# Adapted from transformers_4571.models.mistral.modeling_mistral.MistralModel with MISTRAL->JAMBA, Mistral->Jamba
@auto_docstring
...
# Adapted from transformers_4571.models.mixtral.modeling_mixtral.MixtralForCausalLM with MIXTRAL->JAMBA, Mixtral->Jamba
class JambaForCausalLM(JambaPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, JambaForCausalLM
