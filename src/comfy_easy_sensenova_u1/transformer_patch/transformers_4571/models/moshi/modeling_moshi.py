...
# Copied from transformers_4571.models.gemma.modeling_gemma.GemmaRMSNorm with Gemma->Moshi
...
# Copied from transformers_4571.models.mistral.modeling_mistral.MistralRotaryEmbedding with Mistral->Moshi
...
# Copied from transformers_4571.models.llama.modeling_llama.rotate_half
def rotate_half(x):
...
# Copied from transformers_4571.models.llama.modeling_llama.apply_rotary_pos_emb
...
# NO LONGER EXIST Copied from transformers_4571.models.gemma.modeling_gemma.GemmaFlashAttention2 with Gemma->Moshi
# TODO cyril: modular
...
# NO LONGER EXIST Copied from transformers_4571.models.gemma.modeling_gemma.GemmaSdpaAttention with Gemma->Moshi
# TODO cyril: modular
...
class MoshiDepthDecoder(MoshiPreTrainedModel, GenerationMixin):
    ...
    # Copied from transformers_4571.models.phimoe.modeling_phimoe.PhimoeModel._update_causal_mask with Phimoe->Moshi
    ...
    @staticmethod
    # Copied from transformers_4571.models.phimoe.modeling_phimoe.PhimoeModel._prepare_4d_causal_attention_mask_with_cache_position with Phimoe->MoshiDepth
...
class MoshiModel(MoshiPreTrainedModel):
    ...
    @staticmethod
    # Copied from transformers_4571.models.phimoe.modeling_phimoe.PhimoeModel._prepare_4d_causal_attention_mask_with_cache_position with Phimoe->Moshi
    def _prepare_4d_causal_attention_mask_with_cache_position(
        attention_mask: torch.Tensor,
        sequence_length: int,
        target_length: int,
...
class MoshiForCausalLM(MoshiPreTrainedModel, GenerationMixin):
    ...
    # Copied from transformers_4571.models.gemma.modeling_gemma.GemmaForCausalLM.__init__ with Gemma->Moshi
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, MoshiForCausalLM
...
class MoshiForConditionalGeneration(MoshiPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        Examples:
        ```python
        >>> from transformers_4571 import MoshiForConditionalGeneration
        >>> import torch
    ...
    @staticmethod
    # Copied from transformers_4571.models.musicgen.modeling_musicgen.MusicgenForCausalLM.apply_delay_pattern_mask
