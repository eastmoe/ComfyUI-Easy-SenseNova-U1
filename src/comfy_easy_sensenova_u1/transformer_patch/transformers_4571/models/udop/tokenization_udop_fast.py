...
class UdopTokenizerFast(PreTrainedTokenizerFast):
    ...
    # Copied from transformers_4571.models.layoutxlm.tokenization_layoutxlm_fast.LayoutXLMTokenizerFast.tokenize
    ...
    # Copied from transformers_4571.models.layoutxlm.tokenization_layoutxlm_fast.LayoutXLMTokenizerFast._pad
    def _pad(
        self,
    ...
    # Copied from transformers_4571.models.layoutxlm.tokenization_layoutxlm_fast.LayoutXLMTokenizerFast.save_vocabulary
