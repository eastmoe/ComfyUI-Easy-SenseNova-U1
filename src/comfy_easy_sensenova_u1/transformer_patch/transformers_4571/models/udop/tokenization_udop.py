...
class UdopTokenizer(PreTrainedTokenizer):
    ...
    Args:
        ...
        legacy (`bool`, *optional*, defaults to `True`):
            ...
            - `legacy=True`:
            ```python
            >>> from transformers_4571 import T5Tokenizer
    ...
    # Copied from transformers_4571.models.t5.tokenization_t5.T5Tokenizer.get_vocab
    def get_vocab(self):
        vocab = {self.convert_ids_to_tokens(i): i for i in range(self.vocab_size)}
        vocab.update(self.added_tokens_encoder)
        return vocab

    # Copied from transformers_4571.models.t5.tokenization_t5.T5Tokenizer.get_special_tokens_mask
    ...
    # Copied from transformers_4571.models.t5.tokenization_t5.T5Tokenizer.get_sentinel_tokens
    def get_sentinel_tokens(self):
        return list(
            set(filter(lambda x: bool(re.search(r"<extra_id_\d+>", x)) is not None, self.additional_special_tokens))
        )

    # Copied from transformers_4571.models.t5.tokenization_t5.T5Tokenizer.get_sentinel_token_ids
    def get_sentinel_token_ids(self):
        return [self.convert_tokens_to_ids(token) for token in self.get_sentinel_tokens()]

    # Copied from transformers_4571.models.t5.tokenization_t5.T5Tokenizer._add_eos_if_not_present
    ...
    # Copied from transformers_4571.models.t5.tokenization_t5.T5Tokenizer.create_token_type_ids_from_sequences
    ...
    # Copied from transformers_4571.models.t5.tokenization_t5.T5Tokenizer.build_inputs_with_special_tokens
    ...
    # Copied from transformers_4571.models.t5.tokenization_t5.T5Tokenizer.__getstate__
    ...
    # Copied from transformers_4571.models.t5.tokenization_t5.T5Tokenizer.tokenize
    ...
    # Copied from transformers_4571.models.t5.tokenization_t5.T5Tokenizer._tokenize
    ...
    # Copied from transformers_4571.models.t5.tokenization_t5.T5Tokenizer.convert_tokens_to_string
    ...
    # Copied from transformers_4571.models.t5.tokenization_t5.T5Tokenizer.save_vocabulary
    ...
    # Copied from transformers_4571.models.layoutxlm.tokenization_layoutxlm.LayoutXLMTokenizer.truncate_sequences
    ...
    # Copied from transformers_4571.models.layoutxlm.tokenization_layoutxlm.LayoutXLMTokenizer._pad
    def _pad(
        self,
