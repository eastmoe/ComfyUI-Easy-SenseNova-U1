...
from transformers_4571 import UdopConfig
from transformers_4571.modeling_outputs import (
    Seq2SeqLMOutput,
    Seq2SeqModelOutput,
)
...
class UdopPreTrainedModel(PreTrainedModel):
    ...
    # Copied from transformers_4571.models.prophetnet.modeling_prophetnet.ProphetNetPreTrainedModel._shift_right with ProphetNet->Udop
...
# Copied from transformers_4571.models.t5.modeling_t5.T5LayerNorm with T5->Udop
...
# Copied from transformers_4571.models.t5.modeling_t5.T5DenseActDense with T5->Udop
...
# Copied from transformers_4571.models.t5.modeling_t5.T5DenseGatedActDense with T5->Udop
...
# Copied from transformers_4571.models.t5.modeling_t5.T5LayerFF with T5->Udop
...
# Copied from transformers_4571.models.t5.modeling_t5.T5Attention with T5->Udop
...
# Copied from transformers_4571.models.t5.modeling_t5.T5LayerSelfAttention with T5->Udop
...
# Copied from transformers_4571.models.t5.modeling_t5.T5LayerCrossAttention with T5->Udop
...
# Copied from transformers_4571.models.t5.modeling_t5.T5Block with T5->Udop
...
class UdopModel(UdopPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoProcessor, AutoModel
...
class UdopForConditionalGeneration(UdopPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoProcessor, UdopForConditionalGeneration
        >>> from datasets import load_dataset
...
class UdopEncoderModel(UdopPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoProcessor, UdopEncoderModel
