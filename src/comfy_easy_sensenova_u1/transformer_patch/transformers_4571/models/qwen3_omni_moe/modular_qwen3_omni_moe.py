...
class Qwen3OmniMoeThinkerConfig(Qwen2_5OmniThinkerConfig):
    ...
    ```python
    >>> from transformers_4571 import Qwen3OmniMoeThinkerModel, Qwen3OmniMoeThinkerConfig
...
class Qwen3OmniMoeTalkerConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import Qwen3OmniMoeTalkerConfig, Qwen3OmniMoeTalker
...
class Qwen3OmniMoeCode2WavConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import Qwen3OmniMoeCode2WavConfig, Qwen3OmniMoeCode2WavModel
