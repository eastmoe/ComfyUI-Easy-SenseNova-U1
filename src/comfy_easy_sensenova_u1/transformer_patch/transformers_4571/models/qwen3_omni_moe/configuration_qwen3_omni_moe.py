...
class Qwen3OmniMoeAudioEncoderConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import Qwen3OmniMoeAudioEncoderConfig, Qwen3OmniMoeAudioEncoder
...
class Qwen3OmniMoeTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import Qwen3OmniMoeTextModel, Qwen3OmniMoeTextConfig
...
class Qwen3OmniMoeTalkerCodePredictorConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import Qwen3OmniMoeTalkerCodePredictorModel, Qwen3OmniMoeTalkerCodePredictorConfig
...
class Qwen3OmniMoeTalkerTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import Qwen3OmniMoeTalkerTextModel, Qwen3OmniMoeTalkerTextConfig
