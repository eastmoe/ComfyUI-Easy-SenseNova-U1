...
class FlavaImageConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import FlavaImageConfig, FlavaImageModel
...
class FlavaTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import FlavaTextConfig, FlavaTextModel
...
class FlavaMultimodalConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import FlavaMultimodalConfig, FlavaMultimodalModel
...
class FlavaImageCodebookConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import FlavaImageCodebookConfig, FlavaImageCodebook
...
class FlavaConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import FlavaConfig, FlavaModel, FlavaForPreTraining
