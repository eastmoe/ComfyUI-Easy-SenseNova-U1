...
# Copied from transformers_4571.models.swin.modeling_swin.SwinPatchEmbeddings with Swin->MaskFormerSwin
...
# Copied from transformers_4571.models.swin.modeling_swin.SwinDropPath with Swin->MaskFormerSwin
...
# Copied from transformers_4571.models.swin.modeling_swin.SwinSelfAttention with Swin->MaskFormerSwin
...
# Copied from transformers_4571.models.swin.modeling_swin.SwinSelfOutput with Swin->MaskFormerSwin
...
# Copied from transformers_4571.models.swin.modeling_swin.SwinAttention with Swin->MaskFormerSwin
...
# Copied from transformers_4571.models.swin.modeling_swin.SwinIntermediate with Swin->MaskFormerSwin
...
# Copied from transformers_4571.models.swin.modeling_swin.SwinOutput with Swin->MaskFormerSwin
...
class MaskFormerSwinStage(GradientCheckpointingLayer):
    # Copied from transformers_4571.models.swin.modeling_swin.SwinStage.__init__ with Swin->MaskFormerSwin
...
class MaskFormerSwinEncoder(nn.Module):
    # Copied from transformers_4571.models.swin.modeling_swin.SwinEncoder.__init__ with Swin->MaskFormerSwin
