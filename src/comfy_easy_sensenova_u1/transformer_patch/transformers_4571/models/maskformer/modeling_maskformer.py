...
# Copied from transformers_4571.models.detr.modeling_detr.DetrDecoderOutput
...
# Copied from transformers_4571.models.detr.modeling_detr.DetrDecoderLayer
...
class MaskFormerModel(MaskFormerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoImageProcessor, MaskFormerModel
...
class MaskFormerForInstanceSegmentation(MaskFormerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoImageProcessor, MaskFormerForInstanceSegmentation
        >>> from PIL import Image
        >>> import requests
