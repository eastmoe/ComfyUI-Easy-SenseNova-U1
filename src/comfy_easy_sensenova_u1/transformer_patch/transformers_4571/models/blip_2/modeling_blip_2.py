...
# Copied from transformers_4571.models.clip.modeling_clip.CLIPTextModelOutput with CLIP->Blip2
...
# Copied from transformers_4571.models.clip.modeling_clip.CLIPVisionModelOutput with CLIP->Blip2
...
# Copied from transformers_4571.models.blip.modeling_blip.BlipVisionEmbeddings with Blip->Blip2
...
# Adapted from transformers_4571.models.siglip.modeling_siglip.eager_attention_forward -> BLIP doesn't cast attn weights to fp32
...
# Copied from transformers_4571.models.blip.modeling_blip.BlipEncoderLayer with Blip->Blip2
...
# Copied from transformers_4571.models.blip.modeling_blip.BlipEncoder with Blip->Blip2
...
@auto_docstring
# Copied from transformers_4571.models.blip.modeling_blip.BlipVisionModel with Blip->Blip2, BLIP->BLIP_2
...
# Copied from transformers_4571.models.bert.modeling_bert.BertSelfOutput with Bert->Blip2QFormer
...
# Copied from transformers_4571.models.bert.modeling_bert.BertIntermediate with Bert->Blip2QFormer
...
# Copied from transformers_4571.models.bert.modeling_bert.BertOutput with Bert->Blip2QFormer
...
class Blip2Model(Blip2PreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> import torch
        >>> from transformers_4571 import AutoTokenizer, Blip2Model
    ...
    def get_image_features(
        ...
        ```python
        >>> import torch
        >>> from transformers_4571 import AutoProcessor, Blip2Model
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> import requests
        >>> from transformers_4571 import Blip2Processor, Blip2Model
        >>> import torch
...
class Blip2TextModelWithProjection(Blip2PreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        ```python
        >>> import torch
        >>> from transformers_4571 import AutoProcessor, Blip2TextModelWithProjection
...
class Blip2VisionModelWithProjection(Blip2PreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        ```python
        >>> import torch
        >>> from transformers_4571 import AutoProcessor, Blip2VisionModelWithProjection
        >>> from transformers_4571.image_utils import load_image
...
class Blip2ForConditionalGeneration(Blip2PreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from transformers_4571 import Blip2Processor, Blip2ForConditionalGeneration
        >>> import torch
...
class Blip2ForImageTextRetrieval(Blip2PreTrainedModel):
    ...
    def forward(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, Blip2ForImageTextRetrieval
