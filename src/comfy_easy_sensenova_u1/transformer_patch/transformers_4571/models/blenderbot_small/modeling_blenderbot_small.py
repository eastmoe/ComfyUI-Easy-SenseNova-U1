...
# Copied from transformers_4571.models.blenderbot.modeling_blenderbot.BlenderbotLearnedPositionalEmbedding with Blenderbot->BlenderbotSmall
...
# Copied from transformers_4571.models.bart.modeling_bart.BartAttention with Bart->BlenderbotSmall
...
# Copied from transformers_4571.models.bart.modeling_bart.BartEncoderLayer with Bart->BlenderbotSmall, BART->BLENDERBOT_SMALL
...
# Copied from transformers_4571.models.bart.modeling_bart.BartDecoderLayer with Bart->BlenderbotSmall, BART->BLENDERBOT_SMALL
...
class BlenderbotSmallModel(BlenderbotSmallPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, BlenderbotSmallModel
...
class BlenderbotSmallForConditionalGeneration(BlenderbotSmallPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, BlenderbotSmallForConditionalGeneration
...
# Copied from transformers_4571.models.bart.modeling_bart.BartDecoderWrapper with Bart->BlenderbotSmall
...
# Copied from transformers_4571.models.bart.modeling_bart.BartForCausalLM with Bart->BlenderbotSmall, facebook/bart-base->facebook/blenderbot_small-90M
class BlenderbotSmallForCausalLM(BlenderbotSmallPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, BlenderbotSmallForCausalLM
