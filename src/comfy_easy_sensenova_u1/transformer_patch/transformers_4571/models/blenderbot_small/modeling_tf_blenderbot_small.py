...
# Copied from transformers_4571.models.bart.modeling_tf_bart.shift_tokens_right
...
# Copied from transformers_4571.models.bart.modeling_tf_bart._make_causal_mask
...
# Copied from transformers_4571.models.blenderbot.modeling_tf_blenderbot.TFBlenderbotLearnedPositionalEmbedding with Blenderbot->BlenderbotSmall
...
# Copied from transformers_4571.models.bart.modeling_tf_bart.TFBartAttention with Bart->BlenderbotSmall
...
# Copied from transformers_4571.models.bart.modeling_tf_bart.TFBartEncoderLayer with Bart->BlenderbotSmall
...
# Copied from transformers_4571.models.bart.modeling_tf_bart.TFBartDecoderLayer with Bart->BlenderbotSmall
...
BLENDERBOT_SMALL_GENERATION_EXAMPLE = r"""
    ...
    ```py
    >>> from transformers_4571 import AutoTokenizer, TFBlenderbotSmallForConditionalGeneration
...
class TFBlenderbotSmallModel(TFBlenderbotSmallPreTrainedModel):
    ...
    # Copied from transformers_4571.models.bart.modeling_tf_bart.TFBartModel.serving_output
...
# Copied from transformers_4571.models.bart.modeling_tf_bart.BiasLayer
...
class TFBlenderbotSmallForConditionalGeneration(TFBlenderbotSmallPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    # Copied from transformers_4571.models.bart.modeling_tf_bart.TFBartForConditionalGeneration.serving_output
    def serving_output(self, output):
        pkv = tf.tuple(output.past_key_values)[1] if self.config.use_cache else None
        dec_hs = tf.convert_to_tensor(output.decoder_hidden_states) if self.config.output_hidden_states else None
        dec_attns = tf.convert_to_tensor(output.decoder_attentions) if self.config.output_attentions else None
    ...
    # Copied from transformers_4571.models.bart.modeling_tf_bart.TFBartForConditionalGeneration.prepare_inputs_for_generation
