...
class TableTransformerConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import TableTransformerModel, TableTransformerConfig
    ...
    # Copied from transformers_4571.models.detr.configuration_detr.DetrConfig.__init__
    def __init__(
        self,
        use_timm_backbone=True,
...
# Copied from transformers_4571.models.detr.configuration_detr.DetrOnnxConfig
