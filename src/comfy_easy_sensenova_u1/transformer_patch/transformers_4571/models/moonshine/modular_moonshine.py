...
from transformers_4571.utils.generic import OutputRecorder, check_model_inputs
...
class MoonshineConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import MoonshineModel, MoonshineConfig
...
class MoonshineModel(WhisperModel):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        ```python
        >>> import torch
        >>> from transformers_4571 import AutoFeatureExtractor, MoonshineModel
...
class MoonshineForConditionalGeneration(MoonshinePreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        ```python
        >>> import torch
        >>> from transformers_4571 import AutoProcessor, MoonshineForConditionalGeneration
        >>> from datasets import load_dataset
