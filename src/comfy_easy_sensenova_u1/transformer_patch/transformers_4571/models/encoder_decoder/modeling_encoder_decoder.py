...
class EncoderDecoderModel(PreTrainedModel, GenerationMixin):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        ```python
        >>> from transformers_4571 import EncoderDecoderModel
        ...
        if from_tf:
            from transformers_4571 import TFEncoderDecoderModel
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_4571 import EncoderDecoderModel, BertTokenizer
        >>> import torch
