...
class FlaxEncoderDecoderModel(FlaxPreTrainedModel):
    ...
    def encode(
        ...
        ```python
        >>> from transformers_4571 import FlaxEncoderDecoderModel, BertTokenizer
    ...
    def __call__(
        ...
        ```python
        >>> from transformers_4571 import FlaxEncoderDecoderModel, BertTokenizer, GPT2Tokenizer
    ...
    def from_encoder_decoder_pretrained(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_4571 import FlaxEncoderDecoderModel
