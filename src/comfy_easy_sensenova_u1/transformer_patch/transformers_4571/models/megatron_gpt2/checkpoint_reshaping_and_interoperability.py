...
from transformers_4571 import AutoTokenizer, GPT2Config
from transformers_4571.modeling_utils import WEIGHTS_INDEX_NAME, WEIGHTS_NAME
from transformers_4571.utils import check_torch_load_is_safe
...
def merge_transformers_sharded_states(path, num_checkpoints):
    """
    Merge sharded checkpoints from transformers_4571 into a single checkpoint.
