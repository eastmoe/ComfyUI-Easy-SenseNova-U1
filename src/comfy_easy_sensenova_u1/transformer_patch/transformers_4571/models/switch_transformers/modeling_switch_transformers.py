...
# Copied from transformers_4571.models.t5.modeling_t5.T5LayerNorm with T5->SwitchTransformers
...
# Copied from transformers_4571.models.t5.modeling_t5.T5DenseActDense with T5->SwitchTransformers
...
# Copied from transformers_4571.models.t5.modeling_t5.T5Attention with T5->SwitchTransformers
...
# Copied from transformers_4571.models.t5.modeling_t5.T5LayerSelfAttention with T5->SwitchTransformers
...
# Copied from transformers_4571.models.t5.modeling_t5.T5LayerCrossAttention with T5->SwitchTransformers
...
class SwitchTransformersModel(SwitchTransformersPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, SwitchTransformersModel
...
class SwitchTransformersForConditionalGeneration(SwitchTransformersPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, SwitchTransformersForConditionalGeneration
...
class SwitchTransformersEncoderModel(SwitchTransformersPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, SwitchTransformersEncoderModel
