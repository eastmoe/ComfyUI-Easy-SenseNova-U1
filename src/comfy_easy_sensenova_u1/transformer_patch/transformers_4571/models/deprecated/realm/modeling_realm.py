...
class RealmEmbedder(RealmPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, RealmEmbedder
        >>> import torch
...
class RealmScorer(RealmPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformers_4571 import AutoTokenizer, RealmScorer
...
class RealmKnowledgeAugEncoder(RealmPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformers_4571 import AutoTokenizer, RealmKnowledgeAugEncoder
...
class RealmForOpenQA(RealmPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformers_4571 import RealmForOpenQA, RealmRetriever, AutoTokenizer
