...
class QDQBertLMHeadModel(QDQBertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, QDQBertLMHeadModel, QDQBertConfig
        >>> import torch
...
class QDQBertForNextSentencePrediction(QDQBertPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, QDQBertForNextSentencePrediction
        >>> import torch
