...
class TvltModel(TvltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import TvltProcessor, TvltModel
        >>> import numpy as np
        >>> import torch
...
class TvltForPreTraining(TvltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import TvltProcessor, TvltForPreTraining
        >>> import numpy as np
        >>> import torch
...
class TvltForAudioVisualClassification(TvltPreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from transformers_4571 import TvltProcessor, TvltForAudioVisualClassification
        >>> import numpy as np
        >>> import torch
