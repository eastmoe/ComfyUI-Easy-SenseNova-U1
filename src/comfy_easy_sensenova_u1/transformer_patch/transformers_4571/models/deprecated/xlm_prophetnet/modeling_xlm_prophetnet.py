...
class XLMProphetNetEncoder(XLMProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, XLMProphetNetEncoder
        >>> import torch
...
class XLMProphetNetDecoder(XLMProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, XLMProphetNetDecoder
        >>> import torch
...
class XLMProphetNetModel(XLMProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, XLMProphetNetModel
...
class XLMProphetNetForConditionalGeneration(XLMProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, XLMProphetNetForConditionalGeneration
...
class XLMProphetNetForCausalLM(XLMProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, XLMProphetNetForCausalLM
        >>> import torch
        ...
        >>> from transformers_4571 import BertTokenizer, EncoderDecoderModel, AutoTokenizer
        >>> import torch
