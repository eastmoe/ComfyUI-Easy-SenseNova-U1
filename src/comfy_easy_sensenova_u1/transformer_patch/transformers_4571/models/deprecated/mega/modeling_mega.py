...
# copied from transformers_4571.models.roberta.modeling_roberta.RobertaPooler with Roberta->Mega
...
class MegaForCausalLM(MegaPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, MegaForCausalLM, AutoConfig
        >>> import torch
...
# copied from transformers_4571.models.roberta.modeling_roberta.RobertaClassificationHead with Roberta->Mega
