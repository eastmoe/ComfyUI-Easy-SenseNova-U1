...
# Copied from transformers_4571.models.llava.modeling_llava.LlavaMultiModalProjector with Llava->LlavaNext
...
class LlavaNextForConditionalGeneration(LlavaNextPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> import requests
        >>> from transformers_4571 import AutoProcessor, LlavaNextForConditionalGeneration
