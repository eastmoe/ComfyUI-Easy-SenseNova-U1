...
from transformers_4571.utils import is_vision_available
from transformers_4571.utils.generic import TensorType
...
class VivitImageProcessor(BaseImageProcessor):
    ...
    # Copied from transformers_4571.models.efficientnet.image_processing_efficientnet.EfficientNetImageProcessor.rescale
    def rescale(
        self,
        image: np.ndarray,
