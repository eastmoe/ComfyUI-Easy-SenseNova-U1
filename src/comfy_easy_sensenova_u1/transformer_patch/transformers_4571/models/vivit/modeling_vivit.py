...
class VivitEmbeddings(nn.Module):
    ...
    # Adapted from transformers_4571.models.vit.modeling_vit.ViTEmbeddings.interpolate_pos_encoding
...
# Copied from transformers_4571.models.vit.modeling_vit.ViTSelfAttention with ViT->Vivit
...
# Copied from transformers_4571.models.vit.modeling_vit.ViTSelfOutput with ViT->Vivit
...
# Copied from transformers_4571.models.vit.modeling_vit.ViTAttention with ViT->Vivit
...
class VivitModel(VivitPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> from transformers_4571 import VivitImageProcessor, VivitModel
...
class VivitForVideoClassification(VivitPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> from transformers_4571 import VivitImageProcessor, VivitForVideoClassification
        >>> from huggingface_hub import hf_hub_download
