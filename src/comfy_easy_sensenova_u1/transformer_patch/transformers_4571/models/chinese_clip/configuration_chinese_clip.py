...
class ChineseCLIPTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import ChineseCLIPTextConfig, ChineseCLIPTextModel
...
class ChineseCLIPVisionConfig(PretrainedConfig):
    ...
    Example:
    ```python
    >>> from transformers_4571 import ChineseCLIPVisionConfig, ChineseCLIPVisionModel
...
class ChineseCLIPConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_4571 import ChineseCLIPConfig, ChineseCLIPModel
