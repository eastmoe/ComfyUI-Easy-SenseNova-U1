...
class LEDTokenizerFast(PreTrainedTokenizerFast):
    ...
    ```python
    >>> from transformers_4571 import LEDTokenizerFast
    ...
    # Copied from transformers_4571.models.bart.tokenization_bart_fast.BartTokenizerFast.__init__
    def __init__(
        self,
        vocab_file=None,
        merges_file=None,
    ...
    @property
    # Copied from transformers_4571.models.bart.tokenization_bart_fast.BartTokenizerFast.mask_token with BART->LED
    ...
    # Copied from transformers_4571.models.bart.tokenization_bart_fast.BartTokenizerFast._batch_encode_plus
    ...
    # Copied from transformers_4571.models.bart.tokenization_bart_fast.BartTokenizerFast._encode_plus
    ...
    # Copied from transformers_4571.models.bart.tokenization_bart_fast.BartTokenizerFast.save_vocabulary
    def save_vocabulary(self, save_directory: str, filename_prefix: Optional[str] = None) -> tuple[str]:
        files = self._tokenizer.model.save(save_directory, name=filename_prefix)
        return tuple(files)

    # Copied from transformers_4571.models.bart.tokenization_bart_fast.BartTokenizerFast.build_inputs_with_special_tokens
    ...
    # Copied from transformers_4571.models.bart.tokenization_bart_fast.BartTokenizerFast.create_token_type_ids_from_sequences with BART->LED
    ...
    # Copied from transformers_4571.models.led.tokenization_led.LEDTokenizer._pad
    def _pad(
        self,
