...
# Copied from transformers_4571.models.longformer.modeling_tf_longformer.TFLongformerSelfAttention with TFLongformer->TFLEDEncoder
...
@dataclass
# Copied from transformers_4571.models.longformer.modeling_tf_longformer.TFLongformerBaseModelOutput with TFLongformer->TFLEDEncoder
...
class TFLEDForConditionalGeneration(TFLEDPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from transformers_4571 import AutoTokenizer, TFLEDForConditionalGeneration
        >>> import tensorflow as tf
