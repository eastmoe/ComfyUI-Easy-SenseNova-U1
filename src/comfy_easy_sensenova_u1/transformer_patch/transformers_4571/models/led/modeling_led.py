...
# Copied from transformers_4571.models.longformer.modeling_longformer.LongformerSelfAttention with Longformer->LEDEncoder
...
# Copied from transformers_4571.models.longformer.modeling_longformer.LongformerBaseModelOutput with Longformer->LEDEncoder
...
class LEDForConditionalGeneration(LEDPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformers_4571 import AutoTokenizer, LEDForConditionalGeneration
