...
class Bnb4BitHfQuantizer(HfQuantizer):
    ...
    # Copied from transformers_4571.quantizers.quantizer_bnb_8bit.Bnb8BitHfQuantizer.adjust_max_memory
    def adjust_max_memory(self, max_memory: dict[str, Union[int, str]]) -> dict[str, Union[int, str]]:
        # need more space for buffers that are created during quantization
        max_memory = {key: val * 0.90 for key, val in max_memory.items()}
        return max_memory

    # Copied from transformers_4571.quantizers.quantizer_bnb_8bit.Bnb8BitHfQuantizer.update_dtype
    ...
    # Copied from transformers_4571.quantizers.quantizer_bnb_8bit.Bnb8BitHfQuantizer._process_model_before_weight_loading
    ...
    # Copied from transformers_4571.quantizers.quantizer_bnb_8bit.Bnb8BitHfQuantizer._process_model_after_weight_loading with 8bit->4bit
