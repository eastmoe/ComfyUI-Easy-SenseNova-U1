...
class DynamicCache(Cache):
    ...
    ```python
    >>> from transformers_4571 import AutoTokenizer, AutoModelForCausalLM, DynamicCache
...
class StaticCache(Cache):
    ...
    ```python
    >>> from transformers_4571 import AutoTokenizer, AutoModelForCausalLM, StaticCache
...
class EncoderDecoderCache(Cache):
    ...
    ```python
    >>> from transformers_4571 import AutoProcessor, AutoModelForCausalLM, DynamicCache, EncoderDecoderCache
