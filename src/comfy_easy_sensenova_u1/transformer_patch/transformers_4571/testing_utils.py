...
from transformers_4571 import Trainer
from transformers_4571 import logging as transformers_logging
...
class CaptureLogger:
    ...
    ```python
    >>> from transformers_4571 import logging
    >>> from transformers_4571.testing_utils import CaptureLogger
...
class TestCasePlus(unittest.TestCase):
    ...
    def python_one_liner_max_rss(self, one_liner_str):
        ...
        ```
        one_liner_str = 'from transformers_4571 import AutoModel; AutoModel.from_pretrained("google-t5/t5-large")'
